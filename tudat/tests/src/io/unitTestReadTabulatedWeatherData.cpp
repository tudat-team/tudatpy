...
int main( )
{
    ...
    observation_models::setVmfTroposphereCorrections(
        std::vector< std::string >( { "/home/dominic/Downloads/y2017.vmf3_r.txt" } ),
    ...
    for( std::string groundStation: complex10GroundStations )
    {
        ...
        std::cout<<gs->getTemperatureFunction( )( time )<<std::endl;
        std::cout<<gs->getTemperatureFunction( )( time ) - gs2->getTemperatureFunction( )( time )<<std::endl<<std::endl;
        std::cout<<"Pressure."<<std::endl;
        std::cout<<gs->getPressureFunction( )( time )<<std::endl;
        std::cout<<gs->getPressureFunction( )( time ) - gs2->getPressureFunction( )( time ) <<std::endl<<std::endl;
        std::cout<<"Dew point."<<std::endl;
        std::cout<<gs->getDewPointFunction( )( time )<<std::endl;
        std::cout<<gs->getDewPointFunction( )( time ) - gs2->getDewPointFunction( )( time ) <<std::endl<<std::endl;
        std::cout<<"Vapor pressure."<<std::endl;
        std::cout<<gs->getWaterVaporPartialPressureFunction( )( time )<<std::endl;
        std::cout<<gs->getWaterVaporPartialPressureFunction( )( time ) - gs2->getWaterVaporPartialPressureFunction( )( time ) <<std::endl<<std::endl;
        std::cout<<"Relative humidity."<<std::endl;
        std::cout<<gs->getRelativeHumidityFunction( )( time )<<std::endl;
        std::cout<<gs->getRelativeHumidityFunction( )( time ) - gs2->getRelativeHumidityFunction( )( time ) <<std::endl<<std::endl;
