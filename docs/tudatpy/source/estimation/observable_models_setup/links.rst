...
Functionality in this module is used to create objects of type :class:`~tudatpy.estimation.links.LinkEndId`,
which represents a single participant in an observation, enums of type :class:`~tudatpy.estimation.links.LinkEndType`,
which denotes the role a participant has in an observation (transmitter,receiver, etc.) and :class:`~tudatpy.estimation.links.LinkDefinition`,
