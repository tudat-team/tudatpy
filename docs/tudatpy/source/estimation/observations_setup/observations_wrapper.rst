...
The dataset-backed functions in this module create an :class:`~tudatpy.estimation.observations.ObservationDataset` object, which can then be used as input to perform an estimation (see :ref:`estimation_analysis` module).
