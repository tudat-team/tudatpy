...
These corrections are computed once and applied on an existing observation dataset before
...
.. autosummary::
   ...
   ~tudatpy.estimation.observations.observation_corrections.photocenter_correction.apply_photocenter_correction_to_observation_dataset
   ...
   ~tudatpy.estimation.observations.observation_corrections.light_deflection_correction.apply_light_deflection_correction_to_observation_dataset
...
.. autofunction:: tudatpy.estimation.observations.observation_corrections.photocenter_correction.apply_photocenter_correction_to_observation_dataset
