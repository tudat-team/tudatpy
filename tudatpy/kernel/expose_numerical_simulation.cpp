...
void expose_numerical_simulation( py::module &m )
{
    ...
    py::class_< tudat::Time >( m, "Time", get_docstring( "Time" ).c_str( ) )
            ...
            .def( "to_float", &tudat::Time::getSeconds< double >, get_docstring( "Time.to_float" ).c_str( ) )
            .def( py::self + py::self )
            .def( py::self + double( ) )
            .def( double( ) + py::self )
            .def( py::self += py::self )
    ...
    py::class_< tp::SingleArcDynamicsSimulator< STATE_SCALAR_TYPE, TIME_TYPE >,
            ...
            .def_property_readonly( "bodies", &tp::SingleArcDynamicsSimulator< STATE_SCALAR_TYPE, TIME_TYPE >::getSystemOfBodies )
    ...
    py::class_< tp::SingleArcVariationalEquationsSolver< STATE_SCALAR_TYPE, TIME_TYPE >,
            ...
            m, "SingleArcVariationalSimulator", get_docstring( "SingleArcVariationalSimulator" ).c_str( ) )
            .def( py::init< const tudat::simulation_setup::SystemOfBodies &,
                            const std::shared_ptr< tudat::numerical_integrators::IntegratorSettings< TIME_TYPE > >,
                            const std::shared_ptr< tp::PropagatorSettings< STATE_SCALAR_TYPE > >,
