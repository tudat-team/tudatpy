            ...
            void expose_environment(py::module &m) {
                py::enum_<ta::AerodynamicCoefficientsIndependentVariables>(
                    ...
                    .value(
                        ...
                        ta::AerodynamicCoefficientsIndependentVariables::
                            undefined_independent_variable,
                        get_docstring("AerodynamicCoefficientsIndependentVariab"
                                      "les.undefined_independent_variable")
                            .c_str())
                    .export_values();
                ...
                py::enum_<ta::AerodynamicCoefficientFrames>(
                    ...
                    .value(
                        ...
                        get_docstring("AerodynamicCoefficientFrames.positive_"
                                      "body_fixed_frame_coefficients")
                            .c_str())
                    .value(
                        ...
                        ta::AerodynamicCoefficientFrames::
                            negative_body_fixed_frame_coefficients,
                        get_docstring("AerodynamicCoefficientFrames.negative_"
                                      "body_fixed_frame_coefficients")
                            .c_str())
                    .value(
                        ...
                        ta::AerodynamicCoefficientFrames::
                            positive_aerodynamic_frame_coefficients,
                        get_docstring("AerodynamicCoefficientFrames.positive_"
                                      "aerodynamic_frame_coefficients")
                            .c_str())
                    .value(
                ...
                py::enum_<ta::AtmosphericCompositionSpecies>(
                    ...
                    .value(
                        ...
                        get_docstring("AtmosphericCompositionSpecies.o_species")
                            .c_str())
                    .value("o2_species",
                           ta::AtmosphericCompositionSpecies::o2_species,
                           get_docstring(
                               "AtmosphericCompositionSpecies.o2_species")
                               .c_str())
                    .value("n2_species",
                           ta::AtmosphericCompositionSpecies::n2_species,
                           get_docstring(
                               "AtmosphericCompositionSpecies.n2_species")
                               .c_str())
                    .value("he_species",
                           ta::AtmosphericCompositionSpecies::he_species,
                           get_docstring(
                               "AtmosphericCompositionSpecies.he_species")
                               .c_str())
                    .value(
                        "h_species",
                        ta::AtmosphericCompositionSpecies::h_species,
                        get_docstring("AtmosphericCompositionSpecies.h_species")
                            .c_str())
                    .value("ar_species",
                           ta::AtmosphericCompositionSpecies::ar_species,
                           get_docstring(
                               "AtmosphericCompositionSpecies.ar_species")
                               .c_str())
                    .value(
                        "n_species",
                        ta::AtmosphericCompositionSpecies::n_species,
                        get_docstring("AtmosphericCompositionSpecies.n_species")
                            .c_str())
                    .value(
                        "anomalous_o_species",
                        ta::AtmosphericCompositionSpecies::anomalous_o_species,
                        get_docstring(
                            "AtmosphericCompositionSpecies.anomalous_o_species")
                            .c_str())
                    .export_values();
                ...
                py::class_<ta::AtmosphereModel,
                    ...
                    .def("get_temperature",
                         ...
                         py::arg("altitude"), py::arg("longitude"),
                         py::arg("latitude"), py::arg("time"),
                         get_docstring("AtmosphereModel.get_temperature")
                             .c_str())
                    .def("get_speed_of_sound",
                         &ta::AtmosphereModel::getSpeedOfSound,
                         py::arg("altitude"), py::arg("longitude"),
                         py::arg("latitude"), py::arg("time"),
                         get_docstring("AtmosphereModel.get_speed_of_sound")
                             .c_str())
                    .def("get_number_density",
                         ...
                         py::arg("time"),
                         get_docstring("AtmosphereModel.get_number_density")
                             .c_str());
                ...
                py::class_<
                    ...
                    .def_property_readonly(
                        ...
                        get_docstring(
                            "AerodynamicCoefficientInterface.reference_area")
                            .c_str())
                    .def_property_readonly(
                        "current_force_coefficients",
                        &ta::AerodynamicCoefficientInterface::
                            getCurrentForceCoefficients,
                        get_docstring("AerodynamicCoefficientInterface.current_"
                                      "force_coefficients")
                            .c_str())
                    .def_property_readonly(
                    ...
                    .def_property_readonly(
                        ...
                        get_docstring("AerodynamicCoefficientInterface.force_"
                                      "coefficient_frame")
                            .c_str())
                    .def_property_readonly(
                        ...
                        get_docstring("AerodynamicCoefficientInterface.moment_"
                                      "coefficient_frame")
                            .c_str())
                    .def_property_readonly(
                        ...
                        get_docstring("AerodynamicCoefficientInterface."
                                      "independent_variable_names")
                            .c_str())
                    .def_property_readonly(
                        ...
                        get_docstring("AerodynamicCoefficientInterface.current_"
                                      "control_surface_free_force_coefficients")
                            .c_str())
                    .def_property_readonly(
                        ...
                        get_docstring(
                            "AerodynamicCoefficientInterface.current_control_"
                            "surface_free_moment_coefficients")
                            .c_str())
                    .def_property_readonly(
                        "control_surface_independent_variable_names",
                        &ta::AerodynamicCoefficientInterface::
                            getControlSurfaceIndependentVariables,
                        get_docstring("AerodynamicCoefficientInterface.control_"
                                      "surface_independent_variable_names")
                            .c_str())
                    .def("current_control_surface_force_coefficient_increment",
                         ...
                         get_docstring(
                             "AerodynamicCoefficientInterface.current_control_"
                             "surface_force_coefficient_increment")
                             .c_str())
                    .def("current_control_surface_moment_coefficient_increment",
                         ...
                         get_docstring(
                             "AerodynamicCoefficientInterface.current_control_"
                             "surface_moment_coefficient_increment")
                             .c_str())
                    .def("set_control_surface_increments",
                         &ta::AerodynamicCoefficientInterface::
                             setControlSurfaceIncrements,
                         py::arg("control_surface_list"),
                         get_docstring("AerodynamicCoefficientInterface.set_"
                                       "control_surface_increments")
                             .c_str())
                    .def("update_coefficients",
                         &ta::AerodynamicCoefficientInterface::
                             updateCurrentCoefficients,
                         py::arg("independent_variables"), py::arg("time"),
                         get_docstring("AerodynamicCoefficientInterface.update_"
                                       "coefficients")
                             .c_str())
                ...
                py::class_<
                    ...
                    .def(
                        ...
                        get_docstring("HypersonicLocalInclinationAnalysis.ctor")
                            .c_str())
                    .def("clear_data",
                ...
                py::class_<tsm::VehicleSystems,
                    ...
                    m, "VehicleSystems",
                    get_docstring("VehicleSystems").c_str())
                    .def(py::init<>())
                    .def("set_control_surface_deflection",
                         ...
                         get_docstring(
                             "VehicleSystems.set_control_surface_deflection")
                             .c_str())
                    .def(
                    ...
                    .def("set_default_transponder_turnaround_ratio_function",
                         ...
                         get_docstring("VehicleSystems.set_default_transponder_"
                                       "turnaround_ratio_function")
                             .c_str())
                    .def("get_control_surface_deflection",
                         ...
                         py::arg("control_surface_id"),
                         get_docstring(
                             "VehicleSystems.get_control_surface_deflection")
                             .c_str())
                    .def(
                        "set_reference_point",
                        ...
                        get_docstring("VehicleSystems.set_reference_point")
                            .c_str())
                    ...
                    .def("get_engine_model",
                         ...
                         py::arg("engine_name"),
                         get_docstring("VehicleSystems.get_engine_model")
                             .c_str())
                ...
                py::class_<tss::RigidBodyProperties,
                    ...
                    get_docstring("RigidBodyProperties").c_str())
                ...
                py::class_<trf::AerodynamicAngleCalculator,
                    ...
                    get_docstring("AerodynamicAngleCalculator").c_str())
                    .def("get_rotation_matrix_between_frames",
                         ...
                         get_docstring("AerodynamicAngleCalculator.get_"
                                       "rotation_matrix_between_frames")
                             .c_str())
                    .def("get_angle",
                         &trf::AerodynamicAngleCalculator::getAerodynamicAngle,
                         py::arg("angle_type"),
                         get_docstring("AerodynamicAngleCalculator.get_angle")
                             .c_str())
                ...
                py::class_<ta::FlightConditions,
                    ...
                    m, "FlightConditions",
                    get_docstring("FlightConditions").c_str())
                    //            .def(py::init<
                    //                 const
                    ...
                    .def_property_readonly(
                        ...
                        get_docstring(
                            "FlightConditions.aerodynamic_angle_calculator")
                            .c_str())
                    .def_property_readonly(
                        "longitude", &ta::FlightConditions::getCurrentLongitude,
                        get_docstring("FlightConditions.longitude").c_str())
                    .def_property_readonly(
                    ...
                    .def_property_readonly(
                        ...
                        get_docstring("FlightConditions.time").c_str())
                    .def_property_readonly(
                        "body_centered_body_fixed_state",
                        &ta::FlightConditions::
                            getCurrentBodyCenteredBodyFixedState,
                        get_docstring(
                            "FlightConditions.body_centered_body_fixed_state")
                            .c_str())
                    .def_property_readonly(
                ...
                py::class_<ta::AtmosphericFlightConditions,
                    ...
                    get_docstring("AtmosphericFlightConditions").c_str())
                    .def_property_readonly(
                        "density",
                        &ta::AtmosphericFlightConditions::getCurrentDensity,
                        get_docstring("AtmosphericFlightConditions.density")
                            .c_str())
                    .def_property_readonly(
                        "temperature",
                        &ta::AtmosphericFlightConditions::
                            getCurrentFreestreamTemperature,
                        get_docstring("AtmosphericFlightConditions.temperature")
                            .c_str())
                    .def_property_readonly(
                        "dynamic_pressure",
                        &ta::AtmosphericFlightConditions::
                        ...
                        get_docstring(
                            "AtmosphericFlightConditions.dynamic_pressure")
                            .c_str())
                    .def_property_readonly(
                        "pressure",
                        &ta::AtmosphericFlightConditions::getCurrentPressure,
                        get_docstring("AtmosphericFlightConditions.pressure")
                            .c_str())
                    .def_property_readonly(
                        "airspeed",
                        &ta::AtmosphericFlightConditions::getCurrentAirspeed,
                        get_docstring("AtmosphericFlightConditions.airspeed")
                            .c_str())
                    .def_property_readonly(
                        "mach_number",
                        &ta::AtmosphericFlightConditions::getCurrentMachNumber,
                        get_docstring("AtmosphericFlightConditions.mach_number")
                            .c_str())
                    .def_property_readonly(
                        "airspeed_velocity",
                        &ta::AtmosphericFlightConditions::
                        ...
                        get_docstring(
                            "AtmosphericFlightConditions.airspeed_velocity")
                            .c_str())
                    .def_property_readonly(
                        "speed_of_sound",
                        &ta::AtmosphericFlightConditions::
                        ...
                        get_docstring(
                            "AtmosphericFlightConditions.speed_of_sound")
                            .c_str())
                    .def_property_readonly(
                        "aero_coefficient_independent_variables",
                        &ta::AtmosphericFlightConditions::
                            getAerodynamicCoefficientIndependentVariables,
                        get_docstring("AtmosphericFlightConditions.aero_"
                                      "coefficient_independent_variables")
                            .c_str())
                    .def_property_readonly(
                        ...
                        get_docstring(
                            "AtmosphericFlightConditions.control_surface_aero_"
                            "coefficient_independent_variables")
                            .c_str())
                    .def_property_readonly(
                        ...
                        get_docstring("AtmosphericFlightConditions.aerodynamic_"
                                      "coefficient_interface")
                            .c_str());
                ...
                py::class_<te::Ephemeris, std::shared_ptr<te::Ephemeris>>(
                    m, "Ephemeris", get_docstring("Ephemeris").c_str())
                ...
                py::class_<te::ConstantEphemeris,
                           ...
                           te::Ephemeris>(
                    m, "ConstantEphemeris",
                    get_docstring("ConstantEphemeris").c_str())
                    .def(
                        py::init<
                            const std::function<
                                Eigen::
                    ...
                    .def(py::init<const Eigen::Vector6d,  //<pybind11/eigen.h>
                         ...
                         py::arg("reference_frame_orientation") = "ECLIPJ2000")
                    .def(
                        "update_constant_state",
                        &te::ConstantEphemeris::updateConstantState,
                        py::arg("new_state"),
                        get_docstring("ConstantEphemeris.update_constant_state")
                            .c_str());
                ...
                py::class_<te::RotationalEphemeris,
                    ...
                    get_docstring("RotationalEphemeris").c_str())
                    .def("body_fixed_to_inertial_rotation",
                         &te::RotationalEphemeris::getRotationMatrixToBaseFrame,
                         py::arg("time"),
                         get_docstring("RotationalEphemeris.body_fixed_to_"
                                       "inertial_rotation")
                             .c_str())
                    .def("time_derivative_body_fixed_to_inertial_rotation",
                         ...
                         py::arg("time"),
                         get_docstring("RotationalEphemeris.time_derivative_"
                    ...
                    .def("inertial_to_body_fixed_rotation",
                         ...
                         py::arg("time"),
                         get_docstring("RotationalEphemeris.inertial_to_body_"
                                       "fixed_rotation")
                             .c_str())
                    ...
                    .def("angular_velocity_in_body_fixed_frame",
                         ...
                         py::arg("time"),
                         get_docstring("RotationalEphemeris.angular_velocity_"
                                       "in_body_fixed_frame")
                             .c_str())
                    ...
                    .def_property_readonly(
                        ...
                        get_docstring(
                            "RotationalEphemeris.body_fixed_frame_name")
                            .c_str())
                    .def_property_readonly(
                        "inertial_frame_name",
                        &te::RotationalEphemeris::getBaseFrameOrientation,
                        get_docstring("RotationalEphemeris.inertial_frame_name")
                            .c_str());
                ...
                py::class_<
                    ...
                    get_docstring("EarthOrientationAnglesCalculator").c_str())
                    .def("get_gcrs_to_itrs_rotation_angles",
                         &teo::EarthOrientationAnglesCalculator::
                             getRotationAnglesFromItrsToGcrs<TIME_TYPE>,
                         py::arg("epoch"),
                         py::arg("time_scale") = tba::tdb_scale,
                         get_docstring("EarthOrientationAnglesCalculator.get_"
                                       "gcrs_to_itrs_rotation_angles")
                             .c_str());
                ...
                py::class_<te::GcrsToItrsRotationModel,
                    ...
                    get_docstring("GcrsToItrsRotationModel").c_str())
                    .def_property_readonly(
                        "angles_calculator",
                        &te::GcrsToItrsRotationModel::getAnglesCalculator,
                        get_docstring(
                            "GcrsToItrsRotationModel.angles_calculator")
                            .c_str());
                ...
                py::class_<tg::GravityFieldModel,
                    ...
                    .def_property(
                        ...
                        get_docstring(
                            "GravityFieldModel.gravitational_parameter")
                            .c_str());
                ...
                py::class_<tg::SphericalHarmonicsGravityField,
                    ...
                    get_docstring("SphericalHarmonicsGravityField").c_str())
                    .def_property_readonly(
                        "reference_radius",
                        &tg::SphericalHarmonicsGravityField::getReferenceRadius,
                        get_docstring(
                            "SphericalHarmonicsGravityField.reference_radius")
                            .c_str())
                    .def_property_readonly(
                        "maximum_degree",
                        ...
                        get_docstring(
                            "SphericalHarmonicsGravityField.maximum_degree")
                            .c_str())
                    .def_property_readonly(
                        "maximum_order",
                        &tg::SphericalHarmonicsGravityField::
                            getOrderOfExpansion,
                        get_docstring(
                            "SphericalHarmonicsGravityField.maximum_order")
                            .c_str())
                    .def_property("cosine_coefficients",
                                  ...
                                  get_docstring("SphericalHarmonicsGravityField"
                                                ".cosine_coefficients")
                                      .c_str())
                    .def_property(
                        "sine_coefficients",
                        ...
                        &tg::SphericalHarmonicsGravityField::
                            setSineCoefficients,
                        get_docstring(
                            "SphericalHarmonicsGravityField.sine_coefficients")
                            .c_str());
                ...
                py::class_<tg::TimeDependentSphericalHarmonicsGravityField,
                    ...
                    get_docstring("TimeDependentSphericalHarmonicsGravityField")
                        .c_str())
                    .def_property_readonly(
                        "gravity_field_variation_models",
                        &tg::TimeDependentSphericalHarmonicsGravityField::
                            getGravityFieldVariations,
                        get_docstring("TimeDependentSphericalHarmonicsGravityFi"
                                      "eld.gravity_field_variation_models")
                            .c_str());
                ...
                py::class_<tba::BodyShapeModel,
                    ...
                    .def_property_readonly(
                        ...
                        get_docstring("BodyShapeModel.average_radius").c_str());
                ...
                py::class_<tgs::GroundStationState,
                    ...
                    get_docstring("GroundStationState").c_str())
                    ...
                    .def_property_readonly(
                        ...
                        get_docstring("GroundStationState.rotation_matrix_body_"
                                      "fixed_to_topocentric")
                            .c_str());

                py::class_<tgs::GroundStation,
                           std::shared_ptr<tgs::GroundStation>>(
                    m, "GroundStation", get_docstring("GroundStation").c_str())
                    .def(
                    ...
                    .def_property(
                        ...
                        &tgs::GroundStation::setTransmittingFrequencyCalculator,
                        get_docstring(
                            "GroundStation.transmitting_frequency_calculator")
                            .c_str())
                    .def_property_readonly(
                        "temperature_function",
                        &tgs::GroundStation::getTemperatureFunction,
                        get_docstring("GroundStation.temperature_function")
                            .c_str())
                    .def_property_readonly(
                        "pressure_function",
                        &tgs::GroundStation::getPressureFunction,
                        get_docstring("GroundStation.pressure_function")
                            .c_str())
                    .def_property_readonly(
                        "relative_humidity_function",
                        &tgs::GroundStation::getRelativeHumidityFunction,
                        get_docstring(
                            "GroundStation.relative_humidity_function")
                            .c_str())
                    .def_property_readonly(
                        "pointing_angles_calculator",
                        &tgs::GroundStation::getPointingAnglesCalculator,
                        get_docstring(
                            "GroundStation.pointing_angles_calculator")
                            .c_str())
                    .def_property_readonly(
                        "station_state",
                        &tgs::GroundStation::getNominalStationState,
                        get_docstring("GroundStation.station_state").c_str())
                    .def("set_timing_system",
                ...
                py::class_<tgs::StationFrequencyInterpolator,
                    ...
                    get_docstring("TransmittingFrequencyCalculator").c_str());
                ...
                py::class_<tss::Body, std::shared_ptr<tss::Body>>(
                    m, "Body", get_docstring("Body").c_str())
                    ...
                    .def_property_readonly(
                        ...
                        get_docstring(
                            "Body.inertial_to_body_fixed_frame_derivative")
                            .c_str())
                    .def_property_readonly(
                        ...
                        get_docstring(
                            "Body.body_fixed_to_inertial_frame_derivative")
                            .c_str())
                    .def_property_readonly(
                    ...
                    .def_property_readonly(
                        ...
                        get_docstring("Body.body_fixed_angular_velocity")
                            .c_str())
                    .def_property("mass", &tss::Body::getBodyMass,
                                  &tss::Body::setConstantBodyMass,
                                  get_docstring("Body.mass").c_str())
                    ...
                    .def(
                        ...
                        py::arg("time"),
                        get_docstring("Body.state_in_base_frame_from_ephemeris")
                            .c_str())
                    .def_property("ephemeris", &tss::Body::getEphemeris,
                                  &tss::Body::setEphemeris,
                                  get_docstring("Body.ephemeris").c_str())
                    .def_property(
                    ...
                    .def_property("shape_model", &tss::Body::getShapeModel,
                                  ...
                                  get_docstring("Body.shape_model").c_str())
                    .def_property(
                    ...
                    .def_property(
                        ...
                        get_docstring("Body.aerodynamic_coefficient_interface")
                            .c_str())
                    .def_property(
                    ...
                    .def_property(
                        "rigid_body_properties", &tss::Body::getMassProperties,
                    ...
                    .def_property_readonly(
                        "ground_station_list", &tss::Body::getGroundStationMap,
                        get_docstring("Body.ground_station_list").c_str());


                py::class_<tss::SystemOfBodies,
                           std::shared_ptr<tss::SystemOfBodies>>(
                    m, "SystemOfBodies",
                    get_docstring("SystemOfBodies").c_str())
                    ...
                    .def(
                        ...
                        get_docstring("SystemOfBodies.create_empty_body")
                            .c_str())
                    .def(
                        "does_body_exist", &tss::SystemOfBodies::doesBodyExist,
                        py::arg("body_name"),
                    ...
                    .def(
                        ...
                        get_docstring("SystemOfBodies.global_frame_orientation")
                            .c_str())
                    .def("global_frame_origin",
                         &tss::SystemOfBodies::getFrameOrigin,
                         get_docstring("SystemOfBodies.global_frame_origin")
                             .c_str());
