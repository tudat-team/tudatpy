...
//                 py::arg("aerodynamic_angle_calculator") = std::shared_ptr< tr::AerodynamicAngleCalculator>())
    ...
    py::class_<tsa::SolarActivityData,
        std::shared_ptr<tsa::SolarActivityData>>(
        m, "SolarActivityData" )
        .def_readwrite("bartels_solar_rotation_number", &tsa::SolarActivityData::bartelsSolarRotationNumber,
                       get_docstring("SolarActivityData.bartels_solar_rotation_number").c_str())
        .def_readwrite("f_10_7_adjusted", &tsa::SolarActivityData::solarRadioFlux107Adjusted,
                       get_docstring("SolarActivityData.f_10_7_adjusted").c_str())
        .def_readwrite("f_10_7_observed", &tsa::SolarActivityData::solarRadioFlux107Observed,
                       get_docstring("SolarActivityData.f_10_7_observed").c_str())
        .def_readwrite("f_10_7_adjusted_centered_81_day", &tsa::SolarActivityData::centered81DaySolarRadioFlux107Adjusted,
                       get_docstring("SolarActivityData.f_10_7_adjusted_centered_81_day").c_str())
        .def_readwrite("f_10_7_observed_81_day", &tsa::SolarActivityData::centered81DaySolarRadioFlux107Observed,
                       get_docstring("SolarActivityData.f_10_7_observed_81_day").c_str())
        .def_readwrite("data_type", &tsa::SolarActivityData::dataType,
                       get_docstring("SolarActivityData.data_type").c_str())
        .def_readwrite("bartels_cycle_day", &tsa::SolarActivityData::dayOfBartelsCycle,
                       get_docstring("SolarActivityData.bartels_cycle_day").c_str())
        .def_readwrite("flux_qualifier", &tsa::SolarActivityData::fluxQualifier,
                       get_docstring("SolarActivityData.flux_qualifier").c_str())
        .def_readwrite("international_sun_spot_number", &tsa::SolarActivityData::internationalSunspotNumber,
                       get_docstring("SolarActivityData.international_sun_spot_number").c_str())
        .def_readwrite("f_10_7_adjusted_last_81_day", &tsa::SolarActivityData::last81DaySolarRadioFlux107Adjusted,
                       get_docstring("SolarActivityData.f_10_7_adjusted_last_81_day").c_str())
        .def_readwrite("f_10_7_observed_last_81_day", &tsa::SolarActivityData::last81DaySolarRadioFlux107Observed,
                       get_docstring("SolarActivityData.f_10_7_observed_last_81_day").c_str())
        .def_readwrite("bartels_solar_rotation_number", &tsa::SolarActivityData::planetaryDailyCharacterFigure,
                       get_docstring("SolarActivityData.bartels_solar_rotation_number").c_str())
        .def_readwrite("ap_3_hourly", &tsa::SolarActivityData::planetaryEquivalentAmplitudeVector,
                       get_docstring("SolarActivityData.ap_3_hourly").c_str())
        .def_readwrite("kp_3_hourly", &tsa::SolarActivityData::planetaryRangeIndexVector,
                       get_docstring("SolarActivityData.kp_3_hourly").c_str());


    py::class_<tsa::SolarActivityContainer,
        std::shared_ptr<tsa::SolarActivityContainer>>(
        m, "SolarActivityContainer" )
        .def("get_solar_activity", &tsa::SolarActivityContainer::getSolarActivityData,
             py::arg("epoch"),
             get_docstring("SolarActivityContainer.get_solar_activity").c_str())
        .def_property_readonly("solar_activity_dictionary", &tsa::SolarActivityContainer::getSolarActivityDataMap,
             get_docstring("SolarActivityContainer.solar_activity_dictionary").c_str());
