...
void expose_mass_rate_setup( py::module &m )
{
    ...
    py::enum_< tba::AvailableMassRateModels >( m, "AvailableMassRateModels", get_docstring( "AvailableMassRateModels" ).c_str( ) )
    ...
    py::class_< tss::MassRateModelSettings, std::shared_ptr< tss::MassRateModelSettings > >(
            m, "MassRateModelSettings", get_docstring( "MassRateModelSettings" ).c_str( ) );
    ...
    py::class_< tss::FromThrustMassRateSettings, std::shared_ptr< tss::FromThrustMassRateSettings >, tss::MassRateModelSettings >(
            m, "FromThrustMassRateSettings", get_docstring( "FromThrustMassRateSettings" ).c_str( ) );
    ...
    py::class_< tss::CustomMassRateSettings, std::shared_ptr< tss::CustomMassRateSettings >, tss::MassRateModelSettings >(
            m, "CustomMassRateSettings", get_docstring( "CustomMassRateSettings" ).c_str( ) );
    ...
    m.def( "custom_mass_rate", &tss::customMassRate, py::arg( "mass_rate_function" ), get_docstring( "custom_mass_rate" ).c_str( ) );
}
