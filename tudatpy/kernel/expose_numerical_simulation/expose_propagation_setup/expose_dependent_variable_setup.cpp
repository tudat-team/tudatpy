        ...
        const int dependentVariableSize )
{
    ...
    if( isWarningPrinted == false )
    {
        tudat::utilities::printDeprecationWarning(
                "tudatpy.numerical_simulation.propagation_setup.dependent_variable.custom",
...
void expose_dependent_variable_setup( py::module &m )
{
    ...
    py::enum_< tp::PropagationDependentVariables >(
            m, "PropagationDependentVariables", get_docstring( "PropagationDependentVariables" ).c_str( ) )
    ...
    py::class_< tp::VariableSettings, std::shared_ptr< tp::VariableSettings > >(
            m, "VariableSettings", get_docstring( "VariableSettings" ).c_str( ) );
    ...
    py::class_< tp::SingleDependentVariableSaveSettings, std::shared_ptr< tp::SingleDependentVariableSaveSettings >, tp::VariableSettings >(
            m, "SingleDependentVariableSaveSettings", get_docstring( "SingleDependentVariableSaveSettings" ).c_str( ) );
    //            .def(py::init<
    ...
    m.def( "altitude", &tp::altitudeDependentVariable, py::arg( "body" ), py::arg( "central_body" ), get_docstring( "altitude" ).c_str( ) );
    ...
    m.def( "total_torque_norm", &tp::totalTorqueNormDependentVariable, py::arg( "body" ), get_docstring( "total_torque_norm" ).c_str( ) );

    m.def( "total_torque", &tp::totalTorqueDependentVariable, py::arg( "body" ), get_docstring( "total_torque" ).c_str( ) );
    ...
    m.def( "latitude", &tp::latitudeDependentVariable, py::arg( "body" ), py::arg( "central_body" ), get_docstring( "latitude" ).c_str( ) );
    ...
    m.def( "body_mass", &tp::bodyMassVariable, py::arg( "body" ), get_docstring( "body_mass" ).c_str( ) );
    ...
    m.def( "total_mass_rate", &tp::totalMassRateDependentVariable, py::arg( "body" ), get_docstring( "total_mass_rate" ).c_str( ) );
    ...
    m.def( "center_of_mass", &tp::centerOfMassVariableSaveSettings, py::arg( "body" ), get_docstring( "center_of_mass" ).c_str( ) );

    m.def( "inertia_tensor", &tp::inertiaTensorVariableSaveSettings, py::arg( "body" ), get_docstring( "inertia_tensor" ).c_str( ) );
