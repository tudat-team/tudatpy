...
void expose_acceleration_setup(py::module &m) {
    ...
    py::enum_<tba::AvailableAcceleration>(m, "AvailableAcceleration", get_docstring("AvailableAcceleration").c_str())
            ...
            .value("central_gravity_type", tba::AvailableAcceleration::central_gravity, get_docstring("AvailableAcceleration.central_gravity_type").c_str())
            ...
            .value("third_body_point_mass_gravity_type", tba::AvailableAcceleration::third_body_point_mass_gravity, get_docstring("AvailableAcceleration.third_body_point_mass_gravity_type").c_str())
            .value("third_body_central_gravity_type", tba::AvailableAcceleration::third_body_central_gravity, get_docstring("AvailableAcceleration.third_body_central_gravity_type").c_str())
            .value("third_body_spherical_harmonic_gravity_type", tba::AvailableAcceleration::third_body_spherical_harmonic_gravity, get_docstring("AvailableAcceleration.third_body_spherical_harmonic_gravity_type").c_str())
            .value("third_body_mutual_spherical_harmonic_gravity_type", tba::AvailableAcceleration::third_body_mutual_spherical_harmonic_gravity, get_docstring("AvailableAcceleration.third_body_mutual_spherical_harmonic_gravity_type").c_str())
