...
#ifndef TUDATPY_EXPOSE_ACCELERATION_SETUP_H
#define TUDATPY_EXPOSE_ACCELERATION_SETUP_H
...
{
enum ThrustFrames { unspecified_thrust_frame = -1, inertial_thrust_frame = 0, tnw_thrust_frame = 1 };
