...
void expose_estimation( py::module& m )
{
    ...
    py::class_< tep::EstimatableParameterSet< STATE_SCALAR_TYPE >, std::shared_ptr< tep::EstimatableParameterSet< STATE_SCALAR_TYPE > > >(
            m, "EstimatableParameterSet", get_docstring( "EstimatableParameterSet" ).c_str( ) )
    ...
    py::enum_< tom::ObservationFilterType >( m, "ObservationFilterType", get_docstring( "ObservationFilterType" ).c_str( ) )
    ...
    py::enum_< tom::ObservationSetSplitterType >( m, "ObservationSetSplitterType", get_docstring( "ObservationSetSplitterType" ).c_str( ) )
    ...
    py::enum_< tom::ObservationParserType >( m, "ObservationParserType", get_docstring( "ObservationParserType" ).c_str( ) )
    ...
    py::class_< tom::ObservationFilterBase, std::shared_ptr< tom::ObservationFilterBase > >(
            m, "ObservationFilterBase", get_docstring( "ObservationFilterBase" ).c_str( ) );
    ...
    py::class_< tom::ObservationSetSplitterBase, std::shared_ptr< tom::ObservationSetSplitterBase > >(
            m, "ObservationSetSplitterBase", get_docstring( "ObservationSetSplitterBase" ).c_str( ) );
    ...
    py::class_< tom::ObservationCollectionParser, std::shared_ptr< tom::ObservationCollectionParser > >(
            m, "ObservationCollectionParser", get_docstring( "ObservationCollectionParser" ).c_str( ) );

    m.def( "observation_parser", py::overload_cast<>( &tom::observationParser ), get_docstring( "observation_parser" ).c_str( ) );
    ...
    py::class_< tom::ObservationViabilityCalculator, std::shared_ptr< tom::ObservationViabilityCalculator > >(
            m, "ObservationViabilityCalculator", get_docstring( "ObservationViabilityCalculator" ).c_str( ) )
    ...
    py::class_< tom::ObservationSimulatorBase< STATE_SCALAR_TYPE, TIME_TYPE >,
            ...
            m, "ObservationSimulator", get_docstring( "ObservationSimulator" ).c_str( ) );
    ...
    py::class_< tom::ObservationSimulator< 1, STATE_SCALAR_TYPE, TIME_TYPE >,
            ...
            m, "ObservationSimulator_1", get_docstring( "ObservationSimulator_1" ).c_str( ) );
    ...
    py::class_< tom::ObservationSimulator< 2, STATE_SCALAR_TYPE, TIME_TYPE >,
                ...
                tom::ObservationSimulatorBase< STATE_SCALAR_TYPE, TIME_TYPE > >(
            m, "ObservationSimulator_2", get_docstring( "ObservationSimulator_2" ).c_str( ) );
    ...
    py::class_< tom::ObservationSimulator< 3, STATE_SCALAR_TYPE, TIME_TYPE >,
                ...
                tom::ObservationSimulatorBase< STATE_SCALAR_TYPE, TIME_TYPE > >(
            m, "ObservationSimulator_3", get_docstring( "ObservationSimulator_3" ).c_str( ) );
    ...
    py::class_< tom::ObservationSimulator< 6, STATE_SCALAR_TYPE, TIME_TYPE >,
                ...
                tom::ObservationSimulatorBase< STATE_SCALAR_TYPE, TIME_TYPE > >(
            m, "ObservationSimulator_6", get_docstring( "ObservationSimulator_6" ).c_str( ) );
    ...
    py::class_< tom::ObservationCollection< STATE_SCALAR_TYPE, TIME_TYPE >,
            ...
            m, "ObservationCollection", get_docstring( "ObservationCollection" ).c_str( ) )
    ...
    py::class_< tom::SingleObservationSet< STATE_SCALAR_TYPE, TIME_TYPE >,
            ...
            m, "SingleObservationSet", get_docstring( "SingleObservationSet" ).c_str( ) )
            .def( "set_observations",
                  ...
                  py::arg( "observations" ),
                  get_docstring( "SingleObservationSet.set_observations" ).c_str( ) )
            .def( "set_observations",
                  py::overload_cast< const Eigen::Matrix< STATE_SCALAR_TYPE, Eigen::Dynamic, 1 >& >(
                          &tom::SingleObservationSet< STATE_SCALAR_TYPE, TIME_TYPE >::setObservations ),
                  py::arg( "observations" ),
            ...
            .def( "set_residuals",
                  ...
                  py::arg( "residuals" ),
                  get_docstring( "SingleObservationSet.set_residuals" ).c_str( ) )
            .def( "set_residuals",
                  py::overload_cast< const Eigen::Matrix< STATE_SCALAR_TYPE, Eigen::Dynamic, 1 >& >(
                          &tom::SingleObservationSet< STATE_SCALAR_TYPE, TIME_TYPE >::setResiduals ),
                  py::arg( "residuals" ),
            ...
            .def( "set_constant_weight",
                  ...
                  py::arg( "weight" ),
                  get_docstring( "SingleObservationSet.set_constant_weight" ).c_str( ) )
            .def( "set_constant_weight",
            ...
            .def( "set_tabulated_weights",
                  ...
                  py::arg( "weights" ),
                  get_docstring( "SingleObservationSet.set_tabulated_weights" ).c_str( ) )
            .def( "filter_observations",
    ...
    py::class_< tp::CombinedStateTransitionAndSensitivityMatrixInterface,
            ...
            .def( "full_state_transition_sensitivity_at_epoch",
                  ...
                  py::arg( "add_central_body_dependency" ) = true,
                  py::arg( "arc_defining_bodies" ) = std::vector< std::string >( ),
                  get_docstring( "CombinedStateTransitionAndSensitivityMatrixInterface.full_state_transition_sensitivity_at_epoch" )
                          .c_str( ) )
    ...
    py::class_< tss::EstimationConvergenceChecker, std::shared_ptr< tss::EstimationConvergenceChecker > >(
            m, "EstimationConvergenceChecker", get_docstring( "EstimationConvergenceChecker" ).c_str( ) );
    ...
    py::class_< tss::CovarianceAnalysisInput< STATE_SCALAR_TYPE, TIME_TYPE >,
            ...
            m, "CovarianceAnalysisInput", get_docstring( "CovarianceAnalysisInput" ).c_str( ) )
    ...
    py::class_< tss::EstimationInput< STATE_SCALAR_TYPE, TIME_TYPE >,
            ...
            m, "EstimationInput", get_docstring( "EstimationInput" ).c_str( ) )
            .def( py::init< const std::shared_ptr< tom::ObservationCollection< STATE_SCALAR_TYPE, TIME_TYPE > >&,
                            const Eigen::MatrixXd,
    ...
    py::class_< tss::CovarianceAnalysisOutput< STATE_SCALAR_TYPE, TIME_TYPE >,
            ...
            m, "CovarianceAnalysisOutput", get_docstring( "CovarianceAnalysisOutput" ).c_str( ) )
    ...
    py::class_< tss::EstimationOutput< STATE_SCALAR_TYPE, TIME_TYPE >,
            ...
            m, "EstimationOutput", get_docstring( "EstimationOutput" ).c_str( ) )
