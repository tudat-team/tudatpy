...
void expose_observation_setup( py::module& m )
{
    ...
    py::enum_< tom::ObservableType >(
            m, "ObservableType", get_docstring( "ObservableType" ).c_str( ) )
    ...
    py::enum_< tom::LightTimeFailureHandling >(
            m, "LightTimeFailureHandling", get_docstring( "LightTimeFailureHandling" ).c_str( ) )
    ...
    py::enum_< tom::TroposphericMappingModel >(
            m, "TroposphericMappingModel", get_docstring( "TroposphericMappingModel" ).c_str( ) )
    ...
    py::enum_< tom::ObservationViabilityType >(
            m, "ObservationViabilityType", get_docstring( "ObservationViabilityType" ).c_str( ) )
    ...
    py::class_< tss::ObservationSimulationSettings< TIME_TYPE >,
            ...
            .def_property(
                    ...
                    get_docstring( "ObservationSimulationSettings.viability_settings_list" )
                            .c_str( ) )
            .def_property(
                    "noise_function",
    ...
    py::class_< tom::ObservationAncilliarySimulationSettings,
            ...
            .def( "get_float_settings",
                  ...
                  get_docstring( "ObservationAncilliarySimulationSettings.get_float_settings" )
                          .c_str( ) )
            .def( "get_float_list_settings",
                  &tom::ObservationAncilliarySimulationSettings::getAncilliaryDoubleVectorData,
                  py::arg( "setting_type" ),
                  py::arg( "throw_exception" ) = true,
                  get_docstring( "ObservationAncilliarySimulationSettings.get_float_list_settings" )
                          .c_str( ) );
    ...
    py::enum_< tss::IntegratedObservationPropertyHandling >(
            ...
            get_docstring( "IntegratedObservationPropertyHandling" ).c_str( ) )
    ...
    py::enum_< tom::FrequencyBands >(
            m, "FrequencyBands", get_docstring( "FrequencyBands" ).c_str( ) )
    ...
    py::class_< tom::ProcessedOdfFileContents< TIME_TYPE >,
            ...
            .def_property_readonly(
                    ...
                    get_docstring( "ProcessedOdfFileContents.get_processed_observable_types" )
                            .c_str( ) )
            .def_property_readonly(
                    "start_and_end_time",
            ...
            .def_property_readonly(
                    ...
                    get_docstring( "ProcessedOdfFileContents.get_ignored_odf_observable_types" )
                            .c_str( ) )
            .def_property_readonly(
                    "ignored_ground_stations",
                    &tom::ProcessedOdfFileContents< TIME_TYPE >::getIgnoredGroundStations,
                    get_docstring( "ProcessedOdfFileContents.get_ignored_ground_stations" )
                            .c_str( ) )
            .def_property_readonly(
                    "raw_odf_data",
