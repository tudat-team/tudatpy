...
void expose_observation_setup( py::module& m )
{
    ...
    py::enum_< tom::LinkEndType >( m, "LinkEndType", get_docstring( "LinkEndType" ).c_str( ) )
    ...
    py::class_< tom::LinkEndId, std::shared_ptr< tom::LinkEndId > >( m, "LinkEndId", get_docstring( "LinkEndId" ).c_str( ) )
            .def_property_readonly( "body_name", &tom::LinkEndId::getBodyName, get_docstring( "LinkEndId.body_name" ).c_str( ) )
            .def_property_readonly(
                    "reference_point", &tom::LinkEndId::getStationName, get_docstring( "LinkEndId.reference_point" ).c_str( ) );
    ...
    py::class_< tom::LinkDefinition, std::shared_ptr< tom::LinkDefinition > >(
            m, "LinkDefinition", get_docstring( "LinkDefinition" ).c_str( ) )
            .def( py::init< const std::map< tom::LinkEndType, tom::LinkEndId >& >( ), py::arg( "link_ends" ) )
            .def( "link_end_id",
                  &tom::LinkDefinition::at,
                  py::arg( "link_end_type" ),
                  get_docstring( "LinkDefinition.link_end_id" ).c_str( ) );
    //            .def_property( "link_ends", &tom::LinkDefinition::linkEnds_,
    //                           get_docstring("LinkDefinition.link_ends").c_str() );

    m.def( "link_definition", &tom::linkDefinition, py::arg( "link_ends" ), get_docstring( "link_definition" ).c_str( ) );

    py::enum_< tom::ObservableType >( m, "ObservableType", get_docstring( "ObservableType" ).c_str( ) )
    ...
    py::class_< tom::DopplerProperTimeRateSettings, std::shared_ptr< tom::DopplerProperTimeRateSettings > >(
            m, "DopplerProperTimeRateSettings", get_docstring( "DopplerProperTimeRateSettings" ).c_str( ) );

    py::class_< tom::ObservationModelSettings, std::shared_ptr< tom::ObservationModelSettings > >(
            m, "ObservationSettings", get_docstring( "ObservationSettings" ).c_str( ) );
    ...
    py::class_< tom::OneWayDopplerObservationSettings,
            ...
            m, "OneWayDopplerObservationSettings", get_docstring( "OneWayDopplerObservationSettings" ).c_str( ) );

    py::class_< tom::NWayRangeObservationSettings, std::shared_ptr< tom::NWayRangeObservationSettings >, tom::ObservationModelSettings >(
            m, "NWayRangeObservationSettings", get_docstring( "NWayRangeObservationSettings" ).c_str( ) );

    py::class_< tom::LightTimeConvergenceCriteria, std::shared_ptr< tom::LightTimeConvergenceCriteria > >(
            m, "LightTimeConvergenceCriteria", get_docstring( "LightTimeConvergenceCriteria" ).c_str( ) );

    py::enum_< tom::LightTimeFailureHandling >( m, "LightTimeFailureHandling", get_docstring( "LightTimeFailureHandling" ).c_str( ) )
    ...
    py::class_< tom::LightTimeCorrectionSettings, std::shared_ptr< tom::LightTimeCorrectionSettings > >(
            m, "LightTimeCorrectionSettings", get_docstring( "LightTimeCorrectionSettings" ).c_str( ) );
    ...
    py::enum_< tom::TroposphericMappingModel >( m, "TroposphericMappingModel", get_docstring( "TroposphericMappingModel" ).c_str( ) )
    ...
    py::enum_< tom::WaterVaporPartialPressureModel >(
            m, "WaterVaporPartialPressureModel", get_docstring( "WaterVaporPartialPressureModel" ).c_str( ) )
    ...
    py::class_< tom::ObservationBiasSettings, std::shared_ptr< tom::ObservationBiasSettings > >(
            m, "ObservationBiasSettings", get_docstring( "ObservationBiasSettings" ).c_str( ) );
    ...
    m.def( "absolute_bias", &tom::constantAbsoluteBias, py::arg( "bias_value" ), get_docstring( "absolute_bias" ).c_str( ) );

    m.def( "relative_bias", &tom::constantRelativeBias, py::arg( "bias_value" ), get_docstring( "relative_bias" ).c_str( ) );
    ...
    m.def( "time_drift_bias", &tom::constantTimeDriftBias, py::arg( "bias_value" ), py::arg( "time_link_end" ), py::arg( "ref_epoch" ) );
    ...
    m.def( "combined_bias", &tom::multipleObservationBiasSettings, py::arg( "bias_list" ), get_docstring( "combined_bias" ).c_str( ) );

    m.def( "two_way_time_scale_range_bias", &tom::twoWayTimeScaleRangeBias, get_docstring( "two_way_time_scale_range_bias" ).c_str( ) );

    // ###########    Observation Simulation Settings     #############

    py::enum_< tom::ObservationViabilityType >( m, "ObservationViabilityType", get_docstring( "ObservationViabilityType" ).c_str( ) )
    ...
    py::enum_< tom::ObservationAncilliarySimulationVariable >(
            m, "ObservationAncilliarySimulationVariable", get_docstring( "ObservationAncilliarySimulationVariable" ).c_str( ) )
    ...
    py::class_< tom::ObservationViabilitySettings, std::shared_ptr< tom::ObservationViabilitySettings > >(
            m, "ObservationViabilitySettings", get_docstring( "ObservationViabilityType" ).c_str( ) );
    ...
    py::class_< tss::ObservationSimulationSettings< TIME_TYPE >, std::shared_ptr< tss::ObservationSimulationSettings< TIME_TYPE > > >(
            m, "ObservationSimulationSettings", get_docstring( "ObservationSimulationSettings" ).c_str( ) )
    ...
    py::class_< tss::TabulatedObservationSimulationSettings< TIME_TYPE >,
            ...
            m, "TabulatedObservationSimulationSettings", get_docstring( "TabulatedObservationSimulationSettings" ).c_str( ) );

    py::class_< tom::ObservationAncilliarySimulationSettings, std::shared_ptr< tom::ObservationAncilliarySimulationSettings > >(
            m, "ObservationAncilliarySimulationSettings", get_docstring( "ObservationAncilliarySimulationSettings" ).c_str( ) )
    ...
    m.def( "dsn_n_way_range_ancilliary_settings",
           ...
           py::arg( "link_end_delays" ) = std::vector< double >( ),
           get_docstring( "dsn_n_way_range_ancilliary_settings" ).c_str( ) );
    ...
    py::class_< tss::ObservationDependentVariableSettings, std::shared_ptr< tss::ObservationDependentVariableSettings > >(
            m, "ObservationDependentVariableSettings", get_docstring( "ObservationDependentVariableSettings" ).c_str( ) );
