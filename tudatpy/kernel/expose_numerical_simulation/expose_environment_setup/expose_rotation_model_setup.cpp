...
void expose_rotation_model_setup( py::module &m )
{
    ...
    /////////////////////////////////////////////////////////////////////////////
    py::enum_< tss::RotationModelType >( m, "RotationModelType", get_docstring( "RotationModelType" ).c_str( ) )
    ...
    py::enum_< tba::IAUConventions >( m, "IAUConventions", get_docstring( "IAUConventions" ).c_str( ) )
            .value( "iau_2000_a", tba::IAUConventions::iau_2000_a, get_docstring( "IAUConventions.iau_2000_a" ).c_str( ) )
            .value( "iau_2000_b", tba::IAUConventions::iau_2000_b, get_docstring( "IAUConventions.iau_2000_b" ).c_str( ) )
    ...
    py::class_< tss::SimpleRotationModelSettings, std::shared_ptr< tss::SimpleRotationModelSettings >, tss::RotationModelSettings >(
            m, "SimpleRotationModelSettings", get_docstring( "SimpleRotationModelSettings" ).c_str( ) );

    py::class_< tss::PlanetaryRotationModelSettings, std::shared_ptr< tss::PlanetaryRotationModelSettings >, tss::RotationModelSettings >(
            m, "PlanetaryRotationModelSettings", get_docstring( "PlanetaryRotationModelSettings" ).c_str( ) );
