            ...
            namespace ground_station {
                ...
                void expose_ground_station_setup(py::module &m) {
                    ...
                    py::class_<
                        ...
                        get_docstring("LinearGroundStationMotionSettings")
                            .c_str());
                    ...
                    py::class_<
                        ...
                        get_docstring("CustomGroundStationMotionSettings")
                            .c_str());
                    ...
                    m.def("piecewise_constant_station_motion",
                          ...
                          get_docstring("piecewise_constant_station_motion")
                              .c_str());
                    ...
                    m.def("approximate_ground_stations_position",
                          ...
                          get_docstring("approximate_ground_stations_position")
                              .c_str());
                }
