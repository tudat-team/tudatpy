...
#include "expose_rigid_body_setup.h"
...
void expose_rigid_body_setup( py::module &m )
{
    ...
    //        get_docstring("RigidBodyPropertiesType.from_function_rigid_body_properties").c_str()) .value("constant_rigid_body_properties",
    ...
    //        get_docstring("RigidBodyPropertiesType.mass_dependent_mass_distribution_properties").c_str()) .export_values();
    //
    py::class_< tss::RigidBodyPropertiesSettings, std::shared_ptr< tss::RigidBodyPropertiesSettings > >(
            m, "RigidBodyPropertiesSettings", get_docstring( "RigidBodyPropertiesSettings" ).c_str( ) )
