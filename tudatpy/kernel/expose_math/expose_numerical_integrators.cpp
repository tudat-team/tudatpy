...
void expose_numerical_integrators( py::module& m )
{
    ...
    //  //
    ////  py::class_<tni::RungeKutta4Integrator < double, Eigen::VectorXd, Eigen::VectorXd >,//      tni::NumericalIntegrator<double,
    /// Eigen::VectorXd, Eigen::VectorXd, double> /             std::shared_ptr<tni::RungeKutta4Integrator < double, Eigen::VectorXd,
    /// Eigen::VectorXd >> /             >(m, "RungeKutta4Integrator") /      .def(py::init< /           const stateDerivativeFunction &, /
