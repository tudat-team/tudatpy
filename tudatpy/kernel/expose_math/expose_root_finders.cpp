...
void expose_root_finders( py::module &m )
{
    ...
    py::enum_< trf::MaximumIterationHandling >( m, "MaximumIterationHandling", get_docstring( "MaximumIterationHandling" ).c_str( ) )
            .value( "accept_result",
            ...
            .value( "throw_exception",
                    ...
                    get_docstring( "MaximumIterationHandling.throw_exception" ).c_str( ) )
            .export_values( );
    ...
    py::class_< trf::RootFinderSettings, std::shared_ptr< trf::RootFinderSettings > >(
            m, "RootFinderSettings", get_docstring( "RootFinderSettings" ).c_str( ) );
