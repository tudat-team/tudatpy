        ...
        namespace interpolators {
            ...
            void expose_interpolators(py::module &m) {
                ...
                py::enum_<ti::AvailableLookupScheme>(
                    ...
                    get_docstring("AvailableLookupScheme").c_str())
                    .value(
                        "hunting_algorithm",
                        ti::AvailableLookupScheme::huntingAlgorithm,
                        get_docstring("AvailableLookupScheme.hunting_algorithm")
                            .c_str())
                    .value("binary_search",
                           ti::AvailableLookupScheme::binarySearch,
                           get_docstring("AvailableLookupScheme.binary_search")
                               .c_str())
                    .export_values();

                py::enum_<ti::LagrangeInterpolatorBoundaryHandling>(
                    m, "LagrangeInterpolatorBoundaryHandling",
                    get_docstring("LagrangeInterpolatorBoundaryHandling")
                        .c_str())
                    .value("lagrange_cubic_spline_boundary_interpolation",
                           ...
                           get_docstring(
                               "LagrangeInterpolatorBoundaryHandling.lagrange_"
                               "cubic_spline_boundary_interpolation")
                               .c_str())
                ...
                py::class_<ti::InterpolatorGenerationSettings<tudat::Time>,
                           std::shared_ptr<ti::InterpolatorGenerationSettings<
                               tudat::Time>>>(
                    m, "InterpolatorGenerationSettingsTime",
                    get_docstring("InterpolatorGenerationSettingsTime")
                        .c_str());

                py::class_<ti::InterpolatorGenerationSettings<double>,
                           std::shared_ptr<
                               ti::InterpolatorGenerationSettings<double>>>(
                    m, "InterpolatorGenerationSettingsFloat",
                    get_docstring("InterpolatorGenerationSettingsFloat")
                        .c_str());
                ...
                m.def(
                    ...
                    py::arg("interpolator_settings"), py::arg("initial_time"),
                ...
                m.def("interpolator_generation_settings_float",
                      ...
                      py::arg("interpolator_settings"), py::arg("initial_time"),
                      py::arg("final_time"), py::arg("time_step"),
                      get_docstring("interpolator_generation_settings_float")
                          .c_str());
                ...
                m.def(
                    ...
                    get_docstring("create_one_dimensional_scalar_interpolator")
                        .c_str());
                ...
                m.def(
                    ...
                    get_docstring("create_one_dimensional_vector_interpolator")
                        .c_str());
                ...
                m.def(
                    ...
                    get_docstring("create_one_dimensional_matrix_interpolator")
                        .c_str());
                    ...
                    .def("interpolate",
                         py::overload_cast<const TIME_TYPE>(
                             &ti::OneDimensionalInterpolator<
                                 TIME_TYPE, STATE_SCALAR_TYPE>::interpolate),
                         py::arg("independent_variable_value"),
                         get_docstring(
                             "OneDimensionalInterpolatorScalar.interpolate")
                             .c_str());
                ...
                py::class_<
                    ...
                    .def("interpolate",
                         ...
                         py::arg("independent_variable_value"),
                         get_docstring(
                             "OneDimensionalInterpolatorVector.interpolate")
                             .c_str());
                ...
                py::class_<
                    ...
                    .def("interpolate",
                         ...
                         py::arg("independent_variable_value"),
                         get_docstring(
                             "OneDimensionalInterpolatorMatrix.interpolate")
                             .c_str());
            }
