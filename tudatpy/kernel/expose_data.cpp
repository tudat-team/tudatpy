...
namespace tudatpy {
    ...
    namespace data {
        ...
        void expose_data(py::module &m) {
            ...
            auto mission_data_downloader =
                m.def_submodule("mission_data_downloader");
            mission_data_downloader::expose_mission_data_downloader(
...
:param file_path: Path to the space weather data file.
            ...
            py::class_<
                ...
                .def("add_metadata_val",
                     ...
                     py::arg("tracking_data_type"), py::arg("value"),
                     get_docstring("add_metadata_val").c_str())
                .def("get_available_datatypes",
                     &tio::TrackingTxtFileContents::getAllAvailableDataTypes,
                     get_docstring(
                         "TrackingTxtFileContents.get_available_datatypes")
                         .c_str())
                .def("add_metadata_str",
                     py::overload_cast<tio::TrackingDataType,
                                       const std::string &>(
                         &tio::TrackingTxtFileContents::addMetaData),
                     py::arg("tracking_data_type"), py::arg("str_value"),
                     get_docstring("add_metadata_val").c_str())
            ...
            m.def("grail_mass_level_0_file_reader",
                  &tio::grailMassLevel0FileReader, py::arg("file_name"),
                  get_docstring("grail_mass_level_0_file_reader").c_str());
            m.def("grail_mass_level_1_file_reader",
                  &tio::grailMassLevel1FileReader, py::arg("file_name"),
            ...
            py::enum_<tudat::input_output::TrackingDataType>(
                ...
                .value("receiving_station_name",
                       ...
                       get_docstring("TrackingDataType.receiving_station_name")
                           .c_str())
                .value(
                    "transmitting_station_name",
                    tudat::input_output::TrackingDataType::
                        transmitting_station_name,
                    get_docstring("TrackingDataType.transmitting_station_name")
                        .c_str())
                .export_values();
        };
