...
void expose_data( py::module &m )
{
    ...
    m.def( "get_resource_path", &tudat::paths::get_resource_path, get_docstring( "get_resource_path" ).c_str( ) );
    m.def( "get_ephemeris_path", &tudat::paths::getEphemerisDataFilesPath, get_docstring( "get_ephemeris_path" ).c_str( ) );
    ...
    m.def( "get_quadrature_path", &tudat::paths::getQuadratureDataPath, get_docstring( "get_quadrature_path" ).c_str( ) );
    m.def( "get_spice_kernel_path", &tudat::paths::getSpiceKernelPath, get_docstring( "get_spice_kernel_path" ).c_str( ) );
    m.def( "get_atmosphere_tables_path", &tudat::paths::getAtmosphereTablesPath, get_docstring( "get_atmosphere_tables_path" ).c_str( ) );
    m.def( "get_gravity_models_path", &tudat::paths::getGravityModelsPath, get_docstring( "get_gravity_models_path" ).c_str( ) );
    m.def( "get_space_weather_path", &tudat::paths::getSpaceWeatherDataPath, get_docstring( "get_space_weather_path" ).c_str( ) );
    ...
    py::class_< tudat::input_output::MissileDatcomData, std::shared_ptr< tudat::input_output::MissileDatcomData > >(
            m, "missile_DATCOM_data", get_docstring( "missile_DATCOM_data" ).c_str( ) )
    ...
    py::enum_< tudat::input_output::MissileDatcomData::DynamicCoefficientNames >(
            m, "DynamicCoefficientNames", get_docstring( "DynamicCoefficientNames" ).c_str( ) )
            .value( "cnq",
    ...
    py::enum_< tudat::input_output::MissileDatcomData::StaticCoefficientNames >(
            m, "StaticCoefficientNames", get_docstring( "StaticCoefficientNames" ).c_str( ) )
            .value( "cn",
...
:param file_path: Path to the space weather data file.
    ...
    m.def( "read_odf_file", &tio::readOdfFile, py::arg( "file_name" ), get_docstring( "read_odf_file" ).c_str( ) );
    ...
    py::class_< tudat::input_output::TrackingTxtFileContents, std::shared_ptr< tudat::input_output::TrackingTxtFileContents > >(
            ...
            .def_property_readonly(
                    "num_rows", &tio::TrackingTxtFileContents::getNumRows, get_docstring( "TrackingTxtFileContents.num_rows" ).c_str( ) );

    m.def( "grail_antenna_file_reader",
           &tio::grailAntennaFileReader,
           py::arg( "file_name" ),
           get_docstring( "grail_antenna_file_reader" ).c_str( ) );
    m.def( "grail_mass_level_0_file_reader",
           &tio::grailMassLevel0FileReader,
           py::arg( "file_name" ),
           get_docstring( "grail_mass_level_0_file_reader" ).c_str( ) );
    m.def( "grail_mass_level_1_file_reader",
           &tio::grailMassLevel1FileReader,
           py::arg( "file_name" ),
           py::arg( "data_level" ) = "1b",
           get_docstring( "grail_mass_level_1_file_reader" ).c_str( ) );

    py::enum_< tudat::input_output::TrackingDataType >( m, "TrackingDataType", get_docstring( "TrackingDataType" ).c_str( ) )
            ...
            .value( "receiving_station_name",
                    ...
                    get_docstring( "TrackingDataType.receiving_station_name" ).c_str( ) )
            .value( "transmitting_station_name",
                    tudat::input_output::TrackingDataType::transmitting_station_name,
                    get_docstring( "TrackingDataType.transmitting_station_name" ).c_str( ) )
            .export_values( );
};
