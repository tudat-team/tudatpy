...
void expose_dependent_variable_setup(py::module &m) {
  ...
  py::class_<tp::SingleDependentVariableSaveSettings,
      ...
      .def_property_readonly("variable_type", [](std::shared_ptr<tp::SingleDependentVariableSaveSettings> &a) { return a->dependentVariableType_; })
      .def_property_readonly("associated_body", [](std::shared_ptr<tp::SingleDependentVariableSaveSettings> &a) { return a->associatedBody_; })
      .def_property_readonly("secondary_body", [](std::shared_ptr<tp::SingleDependentVariableSaveSettings> &a) { return a->secondaryBody_; })
      .def_property_readonly("component_index", [](std::shared_ptr<tp::SingleDependentVariableSaveSettings> &a) { return a->componentIndex_; });
  ;
...
void expose_acceleration_setup(py::module &m) {
  ...
  m.def("thrust_acceleration", py::overload_cast<const std::shared_ptr<tss::ThrustDirectionGuidanceSettings>, const std::shared_ptr<tss::ThrustMagnitudeSettings>>(&tss::thrustAcceleration),
        py::arg("thrust_direction_guidance_settings"),
        py::arg("thrust_magnitude_settings"));
  m.def("thrust_acceleration", py::overload_cast<const std::shared_ptr<tinterp::DataInterpolationSettings<double, Eigen::Vector3d>> &, const std::function<double(const double)>, const tss::ThrustFrames, const std::string>(&tss::thrustAcceleration),
        ...
        py::arg("central_body") = "");
  m.def("thrust_acceleration", py::overload_cast<const std::shared_ptr<tinterp::DataInterpolationSettings<double, Eigen::Vector3d>> &, const double, const tss::ThrustFrames, const std::string>(&tss::thrustAcceleration),
        py::arg("data_interpolation_settings"),
...
void expose_propagator_setup(py::module &m) {
  ...
  //      .def("list", &tp::DependentVariableSaveSettings.dependentVariables_);
  ...
  py::enum_<tp::IntegratedStateType>(m, "IntegratedStateType")
      .value("hybrid", tp::IntegratedStateType::hybrid)
      .value("translational", tp::IntegratedStateType::translational_state)
      .value("rotational", tp::IntegratedStateType::rotational_state)
      .value("custom", tp::IntegratedStateType::custom_state);
  ...
  py::class_<
      ...
      .def_property_readonly("state_type", &tp::SingleArcPropagatorSettings<double>::getStateType)
      .def_property_readonly("dependent_variables", [](std::shared_ptr<tp::SingleArcPropagatorSettings<double>> &a) { return a->getDependentVariablesToSave()->dependentVariables_; })
      .def_property_readonly("termination_settings", &tp::SingleArcPropagatorSettings<double>::getTerminationSettings);
...
void expose_propagation_setup(py::module &m) {
  ...
  py::class_<
      ...
      .def_property_readonly("propagator_settings", &tp::SingleArcDynamicsSimulator<double, double>::getPropagatorSettings)
