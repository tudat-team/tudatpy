...
void expose_time_conversion( py::module& m )
{
    ...
    m.def( "datetime_to_tudat", &timePointToDateTime, py::arg( "datetime" ), get_docstring( "datetime_to_tudat" ).c_str( ) );

    m.def( "datetime_to_python", &dateTimeToTimePoint, py::arg( "datetime" ), get_docstring( "datetime_to_python" ).c_str( ) );
    ...
    m.def( "is_leap_year", &tba::isLeapYear, py::arg( "year" ), get_docstring( "is_leap_year" ).c_str( ) );
    ...
    m.def( "TCB_to_TDB", &tba::convertTcbToTdb< double >, py::arg( "TCB_time" ), get_docstring( "TCB_to_TDB" ).c_str( ) );

    m.def( "TDB_to_TCB", &tba::convertTdbToTcb< double >, py::arg( "TDB_time" ), get_docstring( "TDB_to_TCB" ).c_str( ) );

    m.def( "TCG_to_TT", &tba::convertTcgToTt< double >, py::arg( "TCG_time" ), get_docstring( "TCG_to_TT" ).c_str( ) );

    m.def( "TT_to_TCG", &tba::convertTtToTcg< double >, py::arg( "TT_time" ), get_docstring( "TT_to_TCG" ).c_str( ) );

    m.def( "TAI_to_TT", &tba::convertTAItoTT< double >, py::arg( "TAI_time" ), get_docstring( "TAI_to_TT" ).c_str( ) );

    m.def( "TT_to_TAI", &tba::convertTTtoTAI< double >, py::arg( "TT_time" ), get_docstring( "TT_to_TAI" ).c_str( ) );
    ...
    m.def( "default_time_scale_converter", &teo::createDefaultTimeConverterPy, get_docstring( "default_time_scale_converter" ).c_str( ) );

    py::class_< teo::TerrestrialTimeScaleConverter, std::shared_ptr< teo::TerrestrialTimeScaleConverter > >(
            m, "TimeScaleConverter", get_docstring( "TimeScaleConverter" ).c_str( ) )
            .def( "convert_time",
    ...
    py::class_< tba::DateTime >( m, "DateTime", get_docstring( "DateTime" ).c_str( ) )
            ...
            .def( "day_of_year", &tba::DateTime::dayOfYear, get_docstring( "DateTime.day_of_year" ).c_str( ) )
            .def( "epoch", &tba::DateTime::epoch< TIME_TYPE >, get_docstring( "DateTime.epoch" ).c_str( ) )
            .def( "julian_day", &tba::DateTime::julianDay< double >, get_docstring( "DateTime.julian_day" ).c_str( ) )
