...
namespace tudatpy {
        ...
        class PyEphemeris : public te::Ephemeris {
           public:
            ...
            Eigen::Vector6d getCartesianState(
                const double seconds_since_epoch) override {
    ...
    void expose_ephemerides(py::module &m) {
        ...
        //
        //////////////////////////////////////////////////////////////////////////////
        py::class_<te::Ephemeris, std::shared_ptr<te::Ephemeris>>(m,
                                                                  "Ephemeris")
            .def("get_cartesian_state", &te::Ephemeris::getCartesianState,
                 py::arg("seconds_since_epoch") = 0.0)
            .def("get_cartesian_position", &te::Ephemeris::getCartesianPosition,
                 py::arg("seconds_since_epoch") = 0.0)
            .def("get_cartesian_velocity", &te::Ephemeris::getCartesianVelocity,
                 py::arg("seconds_since_epoch") = 0.0);

        py::enum_<tss::EphemerisType>(m.attr("Ephemeris"), "EphemerisType")
            .value("approximate_planet_positions",
                   tss::approximate_planet_positions)
            ...
            .value("interpolated_tle_ephemeris",
                   tss::interpolated_tle_ephemeris)
        ...
        py::class_<te::ConstantEphemeris,
                   std::shared_ptr<te::ConstantEphemeris>, te::Ephemeris>(
            m, "ConstantEphemeris")
            .def(
                py::init<
                    const std::function<
        ...
        py::class_<te::KeplerEphemeris, std::shared_ptr<te::KeplerEphemeris>,
                   te::Ephemeris>(m, "KeplerEphemeris");
