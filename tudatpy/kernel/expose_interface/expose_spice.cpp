...
void expose_spice( py::module &m )
{
    ...
    m.def( "clear_kernels", &tudat::spice_interface::clearSpiceKernels, get_docstring( "clear_kernels" ).c_str( ) );

    m.def( "continue_after_errors", &tudat::spice_interface::toggleErrorReturn, get_docstring( "continue_after_errors" ).c_str( ) );

    m.def( "suppress_error_output", &tudat::spice_interface::suppressErrorOutput, get_docstring( "suppress_error_output" ).c_str( ) );
