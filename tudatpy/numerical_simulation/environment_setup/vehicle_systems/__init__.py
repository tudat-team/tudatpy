...
# the Tudat kernel module `tudatpy.kernel.numerical_simulation.environment_setup.vehicle_systems` with
# its Python extensions defined in `tudatpy/numerical_simulation/environment_setup/vehicle_systems`.
# 
# This allows the import of all the C++ and Python submodules of the 
# `numerical_simulation.environment_setup.vehicle_systems` kernel module directly from tudatpy:
# 
#     from tudatpy.numerical_simulation.environment_setup.vehicle_systems import <any>
# 
# Without the statement below, importing the `numerical_simulation.environment_setup.vehicle_systems` kernel module
# would only be possible as follows, and hybrid Python/C++ modules would not
# be posible in tudatpy.
# 
#     from tudatpy.kernel.numerical_simulation.environment_setup.vehicle_systems import <any>
# 
...
from tudatpy.numerical_simulation.environment_setup.vehicle_systems._import_all_kernel_members import *