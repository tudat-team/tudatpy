...
# its Python extensions defined in `tudatpy/numerical_simulation/propagation_setup/dependent_variable`.
# 
...
from tudatpy.numerical_simulation.propagation_setup.dependent_variable._import_all_kernel_members import *