...
# its Python extensions defined in `tudatpy/numerical_simulation/propagation_setup/mass_rate`.
# 
...
from tudatpy.numerical_simulation.propagation_setup.mass_rate._import_all_kernel_members import *