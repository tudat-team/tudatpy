...
# its Python extensions defined in `tudatpy/numerical_simulation/propagation_setup/torque`.
# 
...
from tudatpy.numerical_simulation.propagation_setup.torque._import_all_kernel_members import *