...
# the Tudat kernel module `tudatpy.kernel.data.sbdb` with
# its Python extensions defined in `tudatpy/data/sbdb`.
# 
# This allows the import of all the C++ and Python submodules of the 
# `data.sbdb` kernel module directly from tudatpy:
# 
#     from tudatpy.data.sbdb import <any>
# 
# Without the statement below, importing the `data.sbdb` kernel module
# would only be possible as follows, and hybrid Python/C++ modules would not
# be posible in tudatpy.
# 
#     from tudatpy.kernel.data.sbdb import <any>
# 
...
from tudatpy.kernel.data.sbdb import *