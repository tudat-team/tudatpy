...
# the Tudat kernel module `tudatpy.kernel.data.horizons` with
# its Python extensions defined in `tudatpy/data/horizons`.
# 
# This allows the import of all the C++ and Python submodules of the 
# `data.horizons` kernel module directly from tudatpy:
# 
#     from tudatpy.data.horizons import <any>
# 
# Without the statement below, importing the `data.horizons` kernel module
# would only be possible as follows, and hybrid Python/C++ modules would not
# be posible in tudatpy.
# 
#     from tudatpy.kernel.data.horizons import <any>
# 
...
from tudatpy.kernel.data.horizons import *