...
#########################################################################################################
    ...
    def generic_strptime(self, date):
        ...
        """ 
        Given a list of supported time formats, try to convert it with the string-parse (strptime) method.
    ...
    def generic_strftime(self, date, format_key):
        ...
        """
        Convert a datetime object to a string based on a supported string format (through strftime method).
...
#########################################################################################################
    ...
    def add_custom_mission_pattern(self, input_mission, custom_pattern):
        ...
        """
        Function allowing users to add a custom pattern among the supported ones.
        Inputs: input_mission (name of mission to be added, string)
                custom_pattern (regex pattern, string)
                
        Outputs: updated dictionary of supported patterns, now containing the custom one.
...
#########################################################################################################
    ...
    def get_extension_for_data_type(self, data_type):
        ...
        """
        Description:
        Returns the corresponding file extension for a given data type. 
        If the data type is supported, it returns the appropriate extension; otherwise, it returns None.

        Input:
            data_type (str): The data type (e.g., 'ck', 'dsk', 'spk').
        Output:
            str: The file extension (str) corresponding to the data_type, or None if the data type is not supported.
        """
