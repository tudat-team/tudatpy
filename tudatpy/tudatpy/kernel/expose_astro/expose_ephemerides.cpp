...
void expose_ephemerides( py::module &m )
{
    ...
    // constantEphemeris.h
    //////////////////////////////////////////////////////////////////////////////
    py::class_< te::ConstantEphemeris, std::shared_ptr< te::ConstantEphemeris >, te::Ephemeris >( m, "ConstantEphemeris" )
            ...
            .def( py::init< const Eigen::Vector6d,  //<pybind11/eigen.h>
                  ...
                  py::arg( "reference_frame_origin" ) = "SSB",
                  py::arg( "reference_frame_orientation" ) = "ECLIPJ2000" )
            .def( "update_constant_state", &te::ConstantEphemeris::updateConstantState, py::arg( "new_state" ) );
    ...
    py::class_< te::TabulatedCartesianEphemeris< double, double >,
            ...
            .def( "reset_interpolator", &te::TabulatedCartesianEphemeris< double, double >::resetInterpolator, py::arg( "interpolator" ) );
};
}  // namespace tudatpy
