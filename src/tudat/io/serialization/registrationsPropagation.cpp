...
/**
 * @file registrationsPropagation.cpp
 ...
 *
 * Consumers should include registrations_propagation.h to retain this translation unit.
 */
...
CEREAL_REGISTER_DYNAMIC_INIT( tudat_serialization_propagation )
