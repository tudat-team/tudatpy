...
double determineChebyshevPolynomialIndependentVariable( const double intervalStart, const double intervalEnd, const double evaluationPoint )
{
...
{
    const double chebyshevX = determineChebyshevPolynomialIndependentVariable( intervalStart, intervalEnd, evaluationPoint );
...
std::vector< double > evaluateChebyshevPolynomials( const double independentChebyshevVariable, const int maximumOrder )
{
    ...
    {
        chebyshevPolynomials.push_back( 2.0 * independentChebyshevVariable * chebyshevPolynomials[ i - 1 ] -
                                        chebyshevPolynomials[ i - 2 ] );
    }
