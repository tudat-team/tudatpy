...
CompositeSurfaceGeometry::CompositeSurfaceGeometry(
        std::vector< std::shared_ptr< SingleSurfaceGeometry > > singleSurfaceGeometryList,
...
std::ostream &operator<<( std::ostream &stream, CompositeSurfaceGeometry &compositeSurfaceGeometry )
{
    ...
    stream << "The number of CompositeSurfaceGeometries is: " << compositeSurfaceGeometry.numberOfCompositeSurfaceGeometries_ << std::endl;
