...
void convert323EulerAnglesToCayleyKleinParameters( const double firstZRotation,
                                                   ...
                                                   std::complex< double >& cayleyKleinB )
{
    cayleyKleinA = std::exp( mathematical_constants::COMPLEX_I * ( firstZRotation + secondZRotation ) / 2.0 ) * std::cos( yRotation / 2.0 );

    cayleyKleinB =
            -std::exp( mathematical_constants::COMPLEX_I * ( firstZRotation - secondZRotation ) / 2.0 ) * std::sin( yRotation / 2.0 );
}
...
void convert313EulerAnglesToCayleyKleinParameters( const double firstZRotation,
                                                   ...
                                                   std::complex< double >& cayleyKleinB )
{
    cayleyKleinA = std::exp( mathematical_constants::COMPLEX_I * ( firstZRotation + secondZRotation ) / 2.0 ) * std::cos( xRotation / 2.0 );
    cayleyKleinB = mathematical_constants::COMPLEX_I *
            std::exp( mathematical_constants::COMPLEX_I * ( firstZRotation - secondZRotation ) / 2.0 ) * std::sin( xRotation / 2.0 );
}
