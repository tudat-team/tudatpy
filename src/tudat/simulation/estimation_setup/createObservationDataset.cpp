...
observation_models::ObservableType getObservableTypeFromTrackingDataString( const std::string& observableTypeString )
{
    ...
    {
        throw std::runtime_error( "Error when creating ObservationDataset from TrackingData: observable type '" + observableTypeString +
                                ...
                                const observation_models::LinkEndType referenceLinkEnd )
{
    ...
    if( linkEnds.empty( ) )
    {
        throw std::runtime_error( "Error when creating ObservationDataset from TrackingData object: no link ends provided for observable " +
    ...
    {
        throw std::runtime_error( "Error when creating ObservationDataset from TrackingData object: the reference link end " +
