                                             ...
                                             const Eigen::VectorXd currentObservation )
{
    ...
    scalingFactorFirstTransmitter_ = calculatePartialOfAngularPositionWrtLinkEndPosition( relativeRangeVectorFirstTransmitter, true, false );
    scalingFactorSecondTransmitter_ = calculatePartialOfAngularPositionWrtLinkEndPosition( relativeRangeVectorSecondTransmitter, true, false );
