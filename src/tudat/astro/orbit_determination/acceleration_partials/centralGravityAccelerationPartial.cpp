...
std::pair< std::function< void( Eigen::MatrixXd& ) >, int > CentralGravitationPartial::getParameterPartialFunctionDerivedAcceleration(
...
std::pair< std::function< void( Eigen::MatrixXd& ) >, int > CentralGravitationPartial::getGravitationalParameterPartialFunction(
...
void CentralGravitationPartial::wrtGravitationalParameterOfCentralBody( Eigen::MatrixXd& gravitationalParameterPartial )
{
    gravitationalParameterPartial =
            computePartialOfCentralGravityWrtGravitationalParameter( currentAcceleratedBodyState_, currentCentralBodyState_ );
}
