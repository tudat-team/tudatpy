import numpy
import tudatpy.data.io.expose_io
...
class ProcessedOdfFileContents:
    ...
    @property
    def raw_odf_data(self) -> list[tudatpy.data.io.expose_io.OdfRawFileContents]:
        ...
...
def add_dependent_variables_to_all(observation_simulation_settings: list[ObservationSimulationSettings], dependent_variable_settings: list[ObservationDependentVariableSettings], bodies: tudatpy.numerical_simulation.environment.expose_environment.SystemOfBodies) -> None:
    ...

def add_dependent_variables_to_observable(observation_simulation_settings: list[ObservationSimulationSettings], dependent_variable_settings: list[ObservationDependentVariableSettings], bodies: tudatpy.numerical_simulation.environment.expose_environment.SystemOfBodies, observable_type: ObservableType) -> None:
    ...

def add_dependent_variables_to_observable_for_link_ends(observation_simulation_settings: list[ObservationSimulationSettings], dependent_variable_settings: list[ObservationDependentVariableSettings], bodies: tudatpy.numerical_simulation.environment.expose_environment.SystemOfBodies, observable_type: ObservableType, link_ends: LinkDefinition) -> None:
    ...
...
def jakowski_ionospheric_light_time_correction(ionosphere_height: float=400000.0, first_order_delay_coefficient: float=40.3, solar_activity_data: dict[float, tudatpy.data.io.expose_io.SolarActivityData]=..., geomagnetic_pole_latitude: float=1.4119713648634127, geomagnetic_pole_longitude: float=-1.2671090369478832, use_utc_for_local_time_computation: bool=False, body_with_atmosphere_name: str='Earth') -> LightTimeCorrectionSettings:
    ...
...
def set_odf_information_in_bodies(processed_odf_file: ProcessedOdfFileContents, bodies: tudatpy.numerical_simulation.environment.expose_environment.SystemOfBodies, body_with_ground_stations_name: str='Earth', turnaround_ratio_function: typing.Callable[[FrequencyBands, FrequencyBands], float]=...) -> None:
    ...
