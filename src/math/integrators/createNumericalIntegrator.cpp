                                                                                           ...
                                                                                           const int numberOfColumns )
{
    ...
    if( numberOfRows % 6 != 0 )
    {
        throw std::runtime_error(
                "Error when getting standard Cartesian element blocks for step-size control; propagated state has incompatible number of "
                "rows: " +
    ...
    {
        throw std::runtime_error(
                "Error when getting standard rotational state element blocks for step-size control; propagated state has more than 1 "
                "column." );
    }
}
                                                                                            ...
                                                                                            const int numberOfColumns )
{
    ...
    {
        throw std::runtime_error(
                "Error when getting standard rotational state element blocks for step-size control; propagated state has incompatible "
                "number of rows: " +
                std::to_string( numberOfRows ) );
    }
...
// Eigen::Matrix< long double, Eigen::Dynamic, 1 >, double > > createIntegrator< double, Eigen::Matrix< long double, Eigen::Dynamic, 1 >,
// double >(
...
// Eigen::Matrix< long double, Eigen::Dynamic, 1 >, long double > > createIntegrator< Time, Eigen::Matrix< long double, Eigen::Dynamic, 1 >,
// long double >(
//         std::function< Eigen::Matrix< long double, Eigen::Dynamic, 1 >(
...
// >, Eigen::Matrix< long double, Eigen::Dynamic, Eigen::Dynamic >, double > > createIntegrator< double, Eigen::Matrix< long double,
// Eigen::Dynamic, Eigen::Dynamic >, double >(
...
//         const Eigen::Matrix< long double, Eigen::Dynamic, Eigen::Dynamic > initialState, std::shared_ptr< IntegratorSettings< double > >
//         integratorSettings );
...
// Eigen::Matrix< long double, Eigen::Dynamic, Eigen::Dynamic >, long double > > createIntegrator< Time, Eigen::Matrix< long double,
// Eigen::Dynamic, Eigen::Dynamic >, long double >(
//         std::function< Eigen::Matrix< long double, Eigen::Dynamic, Eigen::Dynamic >(
//             const Time, const Eigen::Matrix< long double, Eigen::Dynamic, Eigen::Dynamic >& ) > stateDerivativeFunction,
//         const Eigen::Matrix< long double, Eigen::Dynamic, Eigen::Dynamic > initialState, std::shared_ptr< IntegratorSettings< Time > >
//         integratorSettings );
