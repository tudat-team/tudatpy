                                                                              ...
                                                                              const double centralBodyGravitationalParameter )
{
    ...
    double angularMomentumPerUnitGravitationalParameter = std::sqrt( semiLatusRectrum / centralBodyGravitationalParameter );
    ...
    stateDerivative( 0 ) =
            2.0 * semiLatusRectrum / parameterW * angularMomentumPerUnitGravitationalParameter * accelerationsInRswFrame( 1 );
    ...
    double recurringTermInHKJTerms = angularMomentumPerUnitGravitationalParameter * parameterSSquared / ( 2.0 * parameterW );
    ...
    stateDerivative( 5 ) = std::sqrt( semiLatusRectrum * centralBodyGravitationalParameter ) * parameterW * parameterW /
