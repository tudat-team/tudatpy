...
// section 4.3 "Algorithms of shadowing of S_0 by S"
...
// algorithm cited by "SELF-SHADOWING OF A SPACECRAFT IN THE COMPUTATION OF SURFACE FORCES. AN EXAMPLE IN PLANETARY GEODESY" (Balmino et al., 2018)
// appendix B "Point-in-polygon (PIP) algorithms", here is a custom implementation of the ray-casting PIP version to check an entire triangle
...
bool isPointInTriangle( const ParallelProjection& projection_, 
...
// core of the SSH algorithm, inspiration from "SELF-SHADOWING OF A SPACECRAFT IN THE COMPUTATION OF SURFACE FORCES. AN EXAMPLE IN PLANETARY GEODESY" (Balmino et al., 2018)
