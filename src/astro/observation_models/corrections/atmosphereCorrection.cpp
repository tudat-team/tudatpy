...
MappedTroposphericCorrection::MappedTroposphericCorrection(
    ...
    timePerturbation_( 60.0 / 4.0 ), positionRelativePerturbation_( 1.0E-4 )
{ }

double MappedTroposphericCorrection::calculateLightTimeCorrectionPartialDerivativeWrtLinkEndTime( const Eigen::Vector6d& transmitterState,
                                                                                                  const Eigen::Vector6d& receiverState,
                                                                                                  const double transmissionTime,
                                                                                                  const double receptionTime,
 ...
 */
Eigen::Matrix< double, 3, 1 > MappedTroposphericCorrection::calculateLightTimeCorrectionPartialDerivativeWrtLinkEndPosition(
