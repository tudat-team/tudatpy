...
warnings.warn(
    "This submodule is deprecated and will be removed in two minor releases: "
    "Import from `tudatpy.numerical_simulation.environment_setup.ephemeris` instead",
    DeprecationWarning,
    2,
)
...
from ..numerical_simulation.environment_setup import BodyListSettings
