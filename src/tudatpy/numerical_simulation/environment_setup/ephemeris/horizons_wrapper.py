...
from ....constants import expose_constants as constants
from .expose_ephemeris import EphemerisSettings, tabulated
...
class HorizonsQuery:
    ...
    def __init__(
        ...
        epoch_start: datetime.datetime | float | None = None,
        epoch_end: datetime.datetime | float | None = None,
        epoch_step: str | None = None,
        epoch_list: list | None = None,
    ...
    def _format_time_range(self, time: float | datetime.datetime) -> str:
        ...
        if isinstance(time, float) or isinstance(time, int):
            ...
            formatt = r"%Y-%m-%d %H:%M:%S.%f"
            return str(self._convert_time_to_astropy(time).strftime(formatt))
    ...
    def _interpret_timestep(
        self,
        timestep: str,
        start: datetime.datetime | float,
        end: datetime.datetime | float,
    ):
