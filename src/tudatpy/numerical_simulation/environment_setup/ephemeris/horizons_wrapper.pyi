...
import pandas as pd
import re as re
from tudatpy.constants import expose_constants as constants
...
class HorizonsQuery:
    ...
    def _format_time_range(self, time: float | datetime.datetime) -> str:
        """
    ...
    def _interpret_timestep(self, timestep: str, start: datetime.datetime | float, end: datetime.datetime | float):
        """
...
def jpl_horizons(horizons_query: str, horizons_location: str, frame_origin: str, frame_orientation: str='ECLIPJ2000', query_type: str='default', epoch_start: datetime.datetime | float | None=None, epoch_end: datetime.datetime | float | None=None, epoch_step: str | None=None, epoch_list: list | None=None, extended_query: bool=False, aberations: str='geometric') -> tudatpy.numerical_simulation.environment_setup.ephemeris.expose_ephemeris.EphemerisSettings:
