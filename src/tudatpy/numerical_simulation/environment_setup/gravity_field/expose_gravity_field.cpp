...
get_docstring("GravityFieldType.central_gravity").c_str())
...
get_docstring("GravityFieldType.ring_gravity").c_str())
                        .export_values();
...
get_docstring("PredefinedSphericalHarmonicsModel.egm96").c_str())
                        .value("ggm02c", tss::SphericalHarmonicsModel::ggm02c,
get_docstring("PredefinedSphericalHarmonicsModel.ggm02c").c_str())
                        .value("ggm02s", tss::SphericalHarmonicsModel::ggm02s,
get_docstring("PredefinedSphericalHarmonicsModel.ggm02s").c_str())
...
get_docstring("PredefinedSphericalHarmonicsModel.lpe200").c_str())
                        .value("gggrx1200",
                            tss::SphericalHarmonicsModel::lpe200,
get_docstring("PredefinedSphericalHarmonicsModel.ggglpe200rx1200").c_str())
                        .value(
                            "jgmro120d",
