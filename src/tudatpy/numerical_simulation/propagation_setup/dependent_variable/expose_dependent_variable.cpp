                ...
                PYBIND11_MODULE(expose_dependent_variable, m) {
                    ...
                    py::enum_<tp::PropagationDependentVariables>(
                        ...
                        .value("mach_number_type",
                               ...
                               get_docstring("PropagationDependentVariables."
                                             "mach_number_type")
                                   .c_str())
                        .value(
                            "altitude_type",
                            ...
                            get_docstring(
                                "PropagationDependentVariables.altitude_type")
                                .c_str())
                        .value(
                            "airspeed_type",
                            tp::PropagationDependentVariables::
                            ...
                            get_docstring(
                                "PropagationDependentVariables.airspeed_type")
                                .c_str())
                        ...
                        .value(
                            ...
                            get_docstring(
                                "PropagationDependentVariables.aerodynamic_"
                                "moment_coefficients_type")
                                .c_str())
                        .value(
                            ...
                            get_docstring(
                                "PropagationDependentVariables.rotation_matrix_"
                                "to_body_fixed_frame_type")
                                .c_str())
                        .value(
                            ...
                            get_docstring(
                                "PropagationDependentVariables.intermediate_"
                                "aerodynamic_rotation_matrix_type")
                                .c_str())
                        .value(
                            ...
                            get_docstring(
                                "PropagationDependentVariables.relative_body_"
                                "aerodynamic_orientation_angle_type")
                                .c_str())
                        .value(
                            "body_fixed_airspeed_based_velocity_type",
                            tp::PropagationDependentVariables::
                                body_fixed_airspeed_based_velocity_variable,
                            get_docstring("PropagationDependentVariables.body_"
                                          "fixed_airspeed_based_velocity_type")
                                .c_str())
                        ...
                        .value(
                            ...
                            get_docstring("PropagationDependentVariables.tnw_"
                                          "to_inertial_frame_rotation_type")
                                .c_str())
                        .value(
                        ...
                        .value(
                            ...
                            get_docstring(
                                "PropagationDependentVariables.body_fixed_"
                                "groundspeed_based_velocity_type")
                                .c_str())
                        ...
                        .value(
                            ...
                            get_docstring(
                                "PropagationDependentVariables.spherical_"
                                "harmonic_acceleration_terms_type")
                                .c_str())
                        .value(
                            ...
                            get_docstring(
                                "PropagationDependentVariables.spherical_"
                                "harmonic_acceleration_norm_terms_type")
                                .c_str())
                        .value("body_fixed_relative_cartesian_position_type",
                               ...
                               get_docstring(
                                   "PropagationDependentVariables.body_fixed_"
                                   "relative_cartesian_position_type")
                                   .c_str())
                        .value("body_fixed_relative_spherical_position_type",
                               ...
                               get_docstring(
                                   "PropagationDependentVariables.body_fixed_"
                                   "relative_spherical_position_type")
                                   .c_str())
                        .value(
                            ...
                            get_docstring(
                                "PropagationDependentVariables.total_gravity_"
                                "field_variation_acceleration_type")
                                .c_str())
                        .value(
                            ...
                            get_docstring(
                                "PropagationDependentVariables.single_gravity_"
                                "field_variation_acceleration_type")
                                .c_str())
                        .value(
                            ...
                            get_docstring(
                                "PropagationDependentVariables.single_gravity_"
                                "field_variation_acceleration_terms_type")
                                .c_str())
                        .value(
                            ...
                            get_docstring(
                                "PropagationDependentVariables.acceleration_"
                                "partial_wrt_body_translational_state_type")
                                .c_str())
                        ...
                        .value("custom_type",
                               ...
                               get_docstring(
                                   "PropagationDependentVariables.custom_type")
                                   .c_str())
                        ...
                        .value(
                            ...
                            get_docstring(
                                "PropagationDependentVariables.gravity_field_"
                                "laplacian_of_potential_type")
                                .c_str())
                        .export_values();
                    ...
                    py::class_<tp::SingleDependentVariableSaveSettings,
                        ...
                        get_docstring("SingleDependentVariableSaveSettings")
                            .c_str());
                    //            .def(py::init<
                    ...
                    m.def(
                        ...
                        get_docstring("spherical_harmonic_terms_acceleration")
                            .c_str());
                    ...
                    m.def("aerodynamic_force_coefficients",
                          ...
                          py::arg("body"), py::arg("central_body") = "",
                          get_docstring("aerodynamic_force_coefficients")
                              .c_str());

                    m.def("aerodynamic_moment_coefficients",
                          &tp::aerodynamicMomentCoefficientDependentVariable,
                          py::arg("body"), py::arg("central_body") = "",
                          get_docstring("aerodynamic_moment_coefficients")
                              .c_str());
                    ...
                    m.def(
                        ...
                        py::arg("body"), py::arg("central_body") = "",
                        get_docstring("aerodynamic_force_coefficients_control_"
                                      "surface_free")
                            .c_str());
                    ...
                    m.def(
                        ...
                        py::arg("body"), py::arg("central_body") = "",
                        get_docstring("aerodynamic_moment_coefficients_control_"
                                      "surface_free")
                            .c_str());
                    ...
                    m.def(
                        ...
                        py::arg("component_indices"),
                        py::arg("deformation_type"), py::arg("identifier") = "",
                        get_docstring("single_per_term_gravity_field_variation_"
                                      "acceleration")
                            .c_str());
                    ...
                    m.def(
                        ...
                        get_docstring("total_spherical_harmonic_cosine_"
                                      "coefficien_variation")
                            .c_str());
                    ...
                    m.def("total_spherical_harmonic_sine_coefficien_variations",
                          ...
                          py::arg("maximum_degree"), py::arg("minimum_order"),
                          py::arg("maximum_order"),
                          get_docstring("total_spherical_harmonic_sine_"
                                        "coefficien_variation")
                              .c_str());
                    ...
                    m.def(
                        ...
                        get_docstring("total_spherical_harmonic_cosine_"
                                      "coefficien_variations_from_indices")
                            .c_str());
                    ...
                    m.def("central_body_fixed_spherical_position",
                          ...
                          py::arg("body"), py::arg("central_body"),
                          get_docstring("central_body_fixed_spherical_position")
                              .c_str());

                    m.def("central_body_fixed_cartesian_position",
                          &tp::centralBodyFixedCartesianPositionVariable,
                          py::arg("body"), py::arg("central_body"),
                          get_docstring("central_body_fixed_cartesian_position")
                              .c_str());
                    ...
                    m.def("radiation_pressure_coefficient",
                          ...
                          get_docstring("radiation_pressure_coefficient")
                              .c_str());
                    ...
                    m.def(
                        ...
                        py::arg("body_undergoing_acceleration"),
                        py::arg("body_exerting_acceleration"),
                        get_docstring("gravity_field_laplacian_of_potential")
                            .c_str());
                    ...
                    m.def(
                        ...
                        get_docstring("minimum_visible_station_body_distances")
                            .c_str());
                    ...
                    m.def("received_irradiance_shadow_function",
                          ...
                          py::arg("target_body"), py::arg("source_body"),
                          get_docstring("received_irradiance_shadow_function")
                              .c_str());
                    ...
                    m.def("per_target_panel_radiation_pressure_force",
                          ...
                          get_docstring(
                              "per_vehicle_panel_radiation_pressure_force")
                              .c_str());
