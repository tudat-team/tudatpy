        ...
        PYBIND11_MODULE(expose_numerical_simulation, m) {
            ...
            py::class_<tp::SingleArcDynamicsSimulator<double, TIME_TYPE>,
                ...
                .def_property_readonly(
                    ...
                    get_docstring("SingleArcSimulator.integrator_settings")
                        .c_str())
                .def_property_readonly(
                    ...
                    get_docstring(
                        "SingleArcSimulator.state_derivative_function")
                        .c_str())
                .def_property_readonly(
                    "environment_updater",
                    &tp::SingleArcDynamicsSimulator<
                        double, TIME_TYPE>::getEnvironmentUpdater,
                    get_docstring("SingleArcSimulator.environment_updater")
                        .c_str())
                .def_property_readonly(
                    "propagation_results",
                    &tp::SingleArcDynamicsSimulator<
                        double, TIME_TYPE>::getPropagationResults,
                    get_docstring("SingleArcSimulator.propagation_results")
                        .c_str())
                .def_property_readonly(
            ...
            py::class_<
                ...
                .def("integrate_equations_of_motion_only",
                     ...
                     get_docstring("SingleArcVariationalSimulator.integrate_"
                                   "equations_of_motion_only")
                         .c_str())
                ...
                .def_property(
                    ...
                    get_docstring(
                        "SingleArcVariationalSimulator.parameter_vector")
                        .c_str())
                .def_property_readonly(
                    ...
                    get_docstring("SingleArcVariationalSimulator.variational_"
                                  "equations_history")
                        .c_str())
                .def_property_readonly(
                    ...
                    get_docstring("SingleArcVariationalSimulator.state_"
                                  "transition_matrix_history")
                        .c_str())
                .def_property_readonly(
                    "sensitivity_matrix_history",
                    &tp::SingleArcVariationalEquationsSolver<
                        double, TIME_TYPE>::getSensitivityMatrixSolution,
                    get_docstring("SingleArcVariationalSimulator.sensitivity_"
                                  "matrix_history")
                        .c_str())
                .def_property_readonly(
                    "state_history",
                    ...
                    get_docstring("SingleArcVariationalSimulator.state_history")
                        .c_str())
                .def_property_readonly(
                    "dynamics_simulator",
                    &tp::SingleArcVariationalEquationsSolver<
            ...
            py::class_<tss::OrbitDeterminationManager<double, TIME_TYPE>,
                ...
                .def_property_readonly(
                    ...
                    get_docstring("Estimator.state_transition_interface")
                        .c_str())
