...
void expose_coma( py::module& m )
{
    ...
    py::class_< tss::ComaPolyDataset >( m,
         ...
         .. note:: This class cannot be directly instantiated by the user. Create instances using
                   :func:`~tudatpy.data_input.environment_data.coma.coma_model_file_processor`
    ...
    py::class_< tss::ComaWindDatasetCollection >( m,
         ...
         -------
         bool
             True if the collection contains :class:`~tudatpy.data_input.environment_data.coma.ComaPolyDataset` objects,
             False if it contains :class:`~tudatpy.data_input.environment_data.coma.ComaStokesDataset` objects.
         ...
         -------
         bool
             True if the collection contains :class:`~tudatpy.data_input.environment_data.coma.ComaStokesDataset` objects,
             False if it contains :class:`~tudatpy.data_input.environment_data.coma.ComaPolyDataset` objects.
    ...
    py::class_< tss::ComaModelFileProcessor, std::shared_ptr< tss::ComaModelFileProcessor > >( m,
         ...
         Reads and processes polynomial coefficient files to create a :class:`~tudatpy.data_input.environment_data.coma.ComaPolyDataset`.
         This method is only available when the processor was constructed from polynomial coefficient files
         using the file path variant of :func:`~tudatpy.data_input.environment_data.coma.coma_model_file_processor`.
         ...
         using :func:`~tudatpy.data_input.environment_data.coma.coma_model_file_processor`.
         ...
         This method is only available when the processor was constructed from polynomial coefficient files
         using :func:`~tudatpy.data_input.environment_data.coma.coma_model_file_processor`. It transforms
         ...
         with the directory-based variant of :func:`~tudatpy.data_input.environment_data.coma.coma_model_file_processor`.
    ...
    m.def( "coma_model_file_processor",
         ...
         Creates a :class:`~tudatpy.data_input.environment_data.coma.ComaModelFileProcessor` that loads
    ...
    py::class_< tss::ComaWindModelFileProcessor, std::shared_ptr< tss::ComaWindModelFileProcessor > >( m,
         ...
         a :class:`~tudatpy.data_input.environment_data.coma.ComaWindDatasetCollection`. This method is
         ...
         This method is only available when the processor was constructed from Stokes coefficient CSV files
         using :func:`~tudatpy.data_input.environment_data.coma.coma_wind_file_processor`.
         ...
         This method is only available when the processor was constructed from polynomial coefficient files
         using :func:`~tudatpy.data_input.environment_data.coma.coma_wind_file_processor`. It transforms
    ...
    m.def( "coma_wind_file_processor",
         ...
         Creates a :class:`~tudatpy.data_input.environment_data.coma.ComaWindModelFileProcessor` that loads
