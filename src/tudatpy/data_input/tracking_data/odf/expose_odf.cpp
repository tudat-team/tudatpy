...
void expose_odf( py::module& m )
{
    ...
    py::class_< tio::OdfRawFileContents, std::shared_ptr< tio::OdfRawFileContents > >(
            ...
            .def_property_readonly(
                    "data_blocks", &tio::OdfRawFileContents::getDataBlocks, R"doc(list[OdfDataBlock]: ODF data blocks.)doc" )
            .def_property_readonly(
                    "ramp_blocks", &tio::OdfRawFileContents::getRampBlocks, R"doc(list[OdfRampBlock]: ODF ramp blocks.)doc" )
            .def_property_readonly(
                    "clock_offset_blocks", &tio::OdfRawFileContents::getClockOffsetBlocks, R"doc(list: ODF clock-offset blocks.)doc" )
            .def_readonly( "file_reference_date", &tio::OdfRawFileContents::fileReferenceDate_, R"doc(int: ODF file reference date.)doc" )
            .def_readonly( "file_reference_time", &tio::OdfRawFileContents::fileReferenceTime_, R"doc(float: ODF file reference time.)doc" )
...
verbose_output : bool, default=True
    Whether reader progress is printed.
