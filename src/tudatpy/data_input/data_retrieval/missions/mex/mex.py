...
class MexMixin:
    """Mars Express mission file-discovery mixin."""
    ...
    def get_mex_volume_ID(self, start_date, end_date, interval_dict):
        """Return MEX volume identifiers overlapping a date interval.
        ...
        interval_dict : dict
            Mapping from date intervals to volume metadata.

        Returns
        -------
        list[str]
            Matching MEX volume identifiers.
        """
        self.volume_id_list = []
    ...
    def get_url_mex_radio_science_files(
        ...
        """Return MEX radio-science archive URLs for a date interval.

        Parameters
        ----------
        start_date_mex : datetime
            Start of the requested interval.
        end_date_mex : datetime
            End of the requested interval.
        radio_observation_type : str, optional
            Optional radio-science observation type filter.

        Returns
        -------
        list[str]
            Matching MEX radio-science archive URLs.
        """
