...
containing the data, see `user guide description <https://docs.tudat.space/en/latest/user-guide/state-estimation/observation-simulation/observation-collection-manipulation/modifying-collections.html#setting-weights>`_
         ...
         None
            ...
            .def_property( "use_sparse_design_matrix",
                           &tss::CovarianceAnalysisInput< STATE_SCALAR_TYPE, TIME_TYPE >::getUseSparseDesignMatrix,
                           &tss::CovarianceAnalysisInput< STATE_SCALAR_TYPE, TIME_TYPE >::setUseSparseDesignMatrix,
                           R"doc(

        Boolean denoting whether the design matrix is assembled and processed using sparse matrix storage.
    ...
    py::class_< tss::CovarianceAnalysisOutput< STATE_SCALAR_TYPE, TIME_TYPE >,
         ...
         The primary inputs used to create this object are (see `user guide <https://docs.tudat.space/en/latest/user-guide/state-estimation/estimation-settings.html#covariance-analysis-settings>`__ for underlying models)
