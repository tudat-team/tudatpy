...
PYBIND11_MODULE(expose_element_conversion, m) {
    ...
    m.def("cartesian_to_keplerian",
          ...
          tudatpy::get_docstring("cartesian_to_keplerian").c_str());
    ...
    m.def("keplerian_to_cartesian",
          ...
          tudatpy::get_docstring("keplerian_to_cartesian").c_str());
    ...
    m.def("keplerian_to_cartesian_elementwise",
          ...
          tudatpy::get_docstring("keplerian_to_cartesian_elementwise").c_str());
    ...
    m.def("eccentric_to_true_anomaly",
          ...
          tudatpy::get_docstring("eccentric_to_true_anomaly").c_str());


    m.def("eccentric_to_mean_anomaly",
          &toec::convertEccentricAnomalyToMeanAnomaly<double>,
          py::arg("eccentric_anomaly"), py::arg("eccentricity"),
          tudatpy::get_docstring("eccentric_to_mean_anomaly").c_str());
    ...
    m.def("mean_to_eccentric_anomaly",
          ...
          py::arg("non_default_initial_guess") = TUDAT_NAN,
          py::arg("root_finder") = nullptr,
          tudatpy::get_docstring("mean_to_eccentric_anomaly").c_str());
    ...
    m.def("elapsed_time_to_delta_mean_anomaly",
          ...
          tudatpy::get_docstring("elapsed_time_to_delta_mean_anomaly").c_str());
    ...
    m.def("delta_mean_anomaly_to_elapsed_time",
          ...
          py::arg("semi_major_axis"),
          tudatpy::get_docstring("delta_mean_anomaly_to_elapsed_time").c_str());
    ...
    m.def("mean_motion_to_semi_major_axis",
          ...
          tudatpy::get_docstring("mean_motion_to_semi_major_axis").c_str());
    ...
    m.def("semi_major_axis_to_mean_motion",
          ...
          tudatpy::get_docstring("semi_major_axis_to_mean_motion").c_str());
    ...
    m.def("cartesian_to_mee",
          ...
          py::arg("cartesian_elements"), py::arg("gravitational_parameter"),
          tudatpy::get_docstring("cartesian_to_mee").c_str());
    ...
    m.def(
        ...
        py::arg("cartesian_elements"), py::arg("gravitational_parameter"),
        py::arg("singularity_at_zero_inclination"),
        tudatpy::get_docstring("cartesian_to_mee_manual_singularity").c_str());
    ...
    m.def("mee_to_cartesian",
          ...
          py::arg("gravitational_parameter"),
          py::arg("singularity_at_zero_inclination"),
          tudatpy::get_docstring("mee_to_cartesian").c_str());
    ...
    m.def("spherical_to_cartesian_elementwise",
          ...
          tudatpy::get_docstring("spherical_to_cartesian_elementwise").c_str());

    m.def("spherical_to_cartesian",
          py::overload_cast<const Eigen::Vector6d&>(
              &toec::convertSphericalOrbitalToCartesianState<double>),
          py::arg("spherical_elements"),
          tudatpy::get_docstring("spherical_to_cartesian").c_str());

    m.def("cartesian_to_spherical",
          &toec::convertCartesianToSphericalOrbitalState,
          py::arg("cartesian_elements"),
          tudatpy::get_docstring("cartesian_to_spherical").c_str());
    ...
    m.def("quaternion_entries_to_rotation_matrix",
          ...
          tudatpy::get_docstring("quaternion_entries_to_rotation_matrix")
              .c_str());

    m.def("rotation_matrix_to_quaternion_entries",
          &tla::convertMatrixToVectorQuaternionFormat,
          py::arg("rotation_matrix"),
          tudatpy::get_docstring("rotation_matrix_to_quaternion_entries")
              .c_str());
