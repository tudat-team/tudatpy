...
if TYPE_CHECKING:
    from tudatpy.dynamics.environment import FrequencyGapHandling, SystemOfBodies
...
class Trk234Processor:
    ...
    .. code-block:: python
        ...
        from tudatpy.data_access.tracking.processTrk234 import Trk234Processor
    ...
    def __init__(
        ...
        from .converters.derivedDoppler import DerivedDopplerConverter
        from .converters.derivedSraRange import DerivedSraRangeConverter
        from .converters.ramp import RampConverter
        ...
        self.ramp_converter = RampConverter()
    ...
    def set_tnf_information_in_bodies(
        ...
        gap_handling: FrequencyGapHandling | None = None,
