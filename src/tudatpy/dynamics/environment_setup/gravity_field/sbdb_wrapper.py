from tudatpy.data.environment.sbdb import SBDBquery
...
def central_sbdb(MPCcode: Union[str, int]) -> gravity_field.GravityFieldSettings:
    ...
    This function is a wrapper for the tudatpy.data.environment.sbdb functionality.
...
def central_sbdb_density(
    ...
    A simplified gravitational parameter is calculated by assuming a spherical body and homogeneous density.
