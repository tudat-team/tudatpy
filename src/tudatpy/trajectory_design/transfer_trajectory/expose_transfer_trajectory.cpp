        ...
        namespace transfer_trajectory {
            ...
            PYBIND11_MODULE(expose_transfer_trajectory, m) {
                ...
                py::class_<tms::TransferLeg,
                    ...
                    m, "TransferLeg", get_docstring("TransferLeg").c_str())
                ...
                m.def("mga_settings_unpowered_unperturbed_legs",
                      ...
                      py::arg("minimum_pericenters") =
                          tms::DEFAULT_MINIMUM_PERICENTERS,
                      get_docstring("mga_settings_unpowered_unperturbed_legs")
                          .c_str());
                ...
                m.def(
                    ...
                    py::arg("minimum_pericenters") =
                        tms::DEFAULT_MINIMUM_PERICENTERS,
                    get_docstring("mga_settings_dsm_position_based_legs")
                        .c_str());
                ...
                m.def(
                    ...
                    py::arg("minimum_pericenters") =
                        tms::DEFAULT_MINIMUM_PERICENTERS,
                    get_docstring("mga_settings_dsm_velocity_based_legs")
                        .c_str());
                ...
                m.def(
                    ...
                    py::arg("minimum_pericenters") =
                        tms::DEFAULT_MINIMUM_PERICENTERS,
                    get_docstring("mga_settings_spherical_shaping_legs")
                        .c_str());
                ...
                m.def(
                    ...
                    py::arg("minimum_pericenters") =
                        tms::DEFAULT_MINIMUM_PERICENTERS,
                    get_docstring("mga_settings_hodographic_shaping_legs")
                        .c_str());
                ...
                py::class_<tms::TransferTrajectory,
                    ...
                    .def_property_readonly(
                        ...
                        get_docstring("TransferTrajectory.time_of_flight")
                            .c_str())
                    .def("evaluate",
                    ...
                    .def("single_node_delta_v",
                         ...
                         py::arg("node_index"),
                         get_docstring("TransferTrajectory.single_node_delta_v")
                             .c_str())
                    .def("single_leg_delta_v",
                         &tms::TransferTrajectory::getLegDeltaV,
                         py::arg("leg_index"),
                         get_docstring("TransferTrajectory.single_leg_delta_v")
                             .c_str())
                    .def(
                    ...
                    .def("inertial_thrust_accelerations_along_trajectory",
                         ...
                         py::arg("number_of_data_points_per_leg"),
                         get_docstring("TransferTrajectory.inertial_thrust_"
                                       "accelerations_along_trajectory")
                             .c_str())
                    .def("rsw_thrust_accelerations_along_trajectory",
                         ...
                         py::arg("number_of_data_points_per_leg"),
                         get_docstring("TransferTrajectory.rsw_thrust_"
                                       "accelerations_along_trajectory")
                             .c_str())
                    .def("tnw_thrust_accelerations_along_trajectory",
                         ...
                         py::arg("number_of_data_points_per_leg"),
                         get_docstring("TransferTrajectory.tnw_thrust_"
                                       "accelerations_along_trajectory")
                             .c_str())
                    .def_property_readonly(
                        "delta_v_per_node",
                        &tms::TransferTrajectory::getDeltaVPerNode,
                        get_docstring("TransferTrajectory.delta_v_per_node")
                            .c_str())
                    .def_property_readonly(
                        "delta_v_per_leg",
                        &tms::TransferTrajectory::getDeltaVPerLeg,
                        get_docstring("TransferTrajectory.delta_v_per_leg")
                            .c_str())
                    .def_property_readonly(
                        "number_of_nodes",
                        &tms::TransferTrajectory::getNumberOfNodes,
                        get_docstring("TransferTrajectory.number_of_nodes")
                            .c_str())
                    .def_property_readonly(
                        "number_of_legs",
                        &tms::TransferTrajectory::getNumberOfLegs,
                        get_docstring("TransferTrajectory.number_of_legs")
                            .c_str())
                    .def_property_readonly(
                ...
                m.def("unpowered_leg", &tms::unpoweredLeg,
                      get_docstring("unpowered_leg").c_str());

                m.def("dsm_position_based_leg", &tms::dsmPositionBasedLeg,
                      get_docstring("dsm_position_based_leg").c_str());

                m.def("dsm_velocity_based_leg", &tms::dsmVelocityBasedLeg,
                      get_docstring("dsm_velocity_based_leg").c_str());

                m.def("spherical_shaping_leg", &tms::sphericalShapingLeg,
                ...
                m.def("hodographic_shaping_leg", &tms::hodographicShapingLeg,
