...
import matplotlib
import numpy as np
from ..util import pareto_optimums as pareto_optimums, result2array as result2array
...
def trajectory_3d(vehicles_states: dict[float, np.ndarray], vehicles_names: list[str], central_body_name: str, spice_bodies: list[str]=[], frame_orientation: str='J2000', center_plot: bool=False, colors: list[str]=[], linestyles: list[str]=[]):
...
def pareto_front(x_objective: list, y_objective: list, x_label: str, y_label: str, title: str='', c_parameter: list | None=None, c_label: str='', cmap: matplotlib.colors.Colormap | str='viridis', operator: list[min | max]=..., alpha: float=0.85):
