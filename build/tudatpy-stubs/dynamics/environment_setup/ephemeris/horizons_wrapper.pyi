...
from tudatpy.dynamics.environment_setup import BodySettings as BodySettings, ephemeris as ephemeris
...
class HorizonsQuery:
    ...
    query_limit: int
    query_limit_list: int
    epoch_type: Incomplete
    queries: Incomplete
    query_lengths: Incomplete
    num_queries: Incomplete

    def __init__(self, query_id: str, location: str, query_type: str='default', epoch_start: datetime.datetime | float | None=None, epoch_end: datetime.datetime | float | None=None, epoch_step: str | None=None, epoch_list: list | None=None, extended_query: bool=False) -> None:
    ...
    def vectors(self, frame_orientation: str='ECLIPJ2000', aberations: str='geometric') -> astropy.table.Table:
    ...
    def cartesian(self, frame_orientation: str='ECLIPJ2000', aberations: str='geometric') -> np.ndarray:
    ...
    def create_ephemeris_tabulated(self, frame_origin: str, frame_orientation: str='ECLIPJ2000', aberations: str='geometric') -> ephemeris.EphemerisSettings:
    ...
    def ephemerides(self, reference_system: str='J2000', extra_precision: bool=False, *args, **kwargs) -> astropy.table.Table:
    ...
    def interpolated_observations(self, degrees: bool=False, reference_system: str='J2000', extra_precision: bool=True, *args, **kwargs) -> np.ndarray:
    ...
    def interpolated_station_angles(self, degrees: bool=False, reference_system: str='J2000', extra_precision: bool=True, *args, **kwargs) -> np.ndarray:
        """Retrieves interpolated Right Ascension and Declination from the Horizons ephemerides API.
        Note that these values are not real observations but instead interpolated
        values based on the Horizons ephemeris system.
...
class HorizonsBatch:
    ...
    def __init__(self, query_id_list: list[str], location: str, epoch_list: list | None=None, epoch_start: datetime.datetime | float | None=None, epoch_end: datetime.datetime | float | None=None, epoch_step: str | None=None, extended_query: bool=False) -> None:
    ...
    @property
    def names(self) -> None | list[str]:
        """Retrieves a list of names of the query objects. Returns `None`
        if `add_batch_ephemerides` has not been run yet."""

    def add_batch_ephemerides(self, body_settings: BodyListSettings, frame_origin: str, frame_orientation: str='ECLIPJ2000', aberations: str='geometric') -> None:
...
def jpl_horizons(horizons_query: str, horizons_location: str, frame_origin: str, frame_orientation: str='ECLIPJ2000', query_type: str='default', epoch_start: datetime.datetime | float | None=None, epoch_end: datetime.datetime | float | None=None, epoch_step: str | None=None, epoch_list: list | None=None, extended_query: bool=False, aberations: str='geometric'):
