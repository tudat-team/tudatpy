...
from ....dynamics.environment_setup import radiation_pressure
from ....dynamics.environment_setup import rotation_model
import typing
__all__ = ['BodyPanelGeometrySettings', 'BodyPanelSettings', 'FrameFixedBodyPanelGeometrySettings', 'FrameVariableBodyPanelGeometrySettings', 'FullPanelledBodySettings', 'MaterialProperties', 'body_panel_settings', 'body_panel_settings_list_from_dae', 'body_tracking_panel_geometry', 'box_wing_panelled_body_settings', 'frame_fixed_panel_geometry', 'full_panelled_body_settings', 'material_properties', 'merge_body_panel_setting_lists', 'time_varying_panel_geometry']
...
class BodyPanelSettings:
    ...
    @property
    def panel_geometry(self) -> BodyPanelGeometrySettings:
        """
    ...
    @panel_geometry.setter
    def panel_geometry(self, arg0: BodyPanelGeometrySettings) -> None:
        ...
    ...
    @panel_type_id.setter
    def panel_type_id(self, arg0: str) -> None:
        ...

    @property
    def reflection_law_settings(self) -> radiation_pressure.BodyPanelReflectionLawSettings:
        """
    ...
    @reflection_law_settings.setter
    def reflection_law_settings(self, arg0: radiation_pressure.BodyPanelReflectionLawSettings) -> None:
        ...

class FrameFixedBodyPanelGeometrySettings(BodyPanelGeometrySettings):
    ...
    @area.setter
    def area(self, arg0: float) -> None:
        ...

    @property
    def surface_normal(self) -> typing.Annotated[numpy.ndarray, numpy.float64, pybind11_stubgen.typing_ext.FixedSize(3, 1)]:
        """
    ...
    def surface_normal(self, arg0: typing.Annotated[numpy.ndarray, numpy.float64, pybind11_stubgen.typing_ext.FixedSize(3, 1)]) -> None:
        ...

class FrameVariableBodyPanelGeometrySettings(BodyPanelGeometrySettings):
    ...
    @property
    def surface_normal_function(self) -> typing.Callable[[], typing.Annotated[numpy.ndarray, numpy.float64, pybind11_stubgen.typing_ext.FixedSize(3, 1)]]:
        """
    ...
    @surface_normal_function.setter
    def surface_normal_function(self, arg0: typing.Callable[[], typing.Annotated[numpy.ndarray, numpy.float64, pybind11_stubgen.typing_ext.FixedSize(3, 1)]]) -> None:
        ...
...
class FullPanelledBodySettings:
    ...
    @property
    def panel_settings_list(self) -> list[BodyPanelSettings]:
        """
    ...
    @panel_settings_list.setter
    def panel_settings_list(self, arg0: list[BodyPanelSettings]) -> None:
        ...

    @property
    def part_rotation_model_settings(self) -> dict[str, rotation_model.RotationModelSettings]:
        """
    ...
    @part_rotation_model_settings.setter
    def part_rotation_model_settings(self, arg0: dict[str, rotation_model.RotationModelSettings]) -> None:
        ...

class MaterialProperties:
    diffuse_reflectivity: float
    energy_accomodation_coefficient: float
    normal_accomodation_coefficient: float
    normal_velocity_at_wall_ratio: float
    specular_reflectivity: float
    tangential_accomodation_coefficient: float

def body_panel_settings(panel_geometry: BodyPanelGeometrySettings, panel_reflection_law: radiation_pressure.BodyPanelReflectionLawSettings, panel_type_id: str='', material_properties: ...={}) -> BodyPanelSettings:
...
def body_panel_settings_list_from_dae(file_path: str, frame_origin: typing.Annotated[numpy.ndarray, numpy.float64, pybind11_stubgen.typing_ext.FixedSize(3, 1)], material_properties: dict[str, ...], reradiation_settings: dict[str, bool], frame_orientation: str='') -> list[BodyPanelSettings]:
...
def frame_fixed_panel_geometry(surface_normal: typing.Annotated[numpy.ndarray, numpy.float64, pybind11_stubgen.typing_ext.FixedSize(3, 1)], area: float, frame_orientation: str='') -> BodyPanelGeometrySettings:
...
def full_panelled_body_settings(panel_settings: list[BodyPanelSettings], part_rotation_model_settings: dict[str, rotation_model.RotationModelSettings]={}) -> FullPanelledBodySettings:
...
def material_properties(specular_reflectivity: float=-1, diffuse_reflectivity: float=-1, energy_accomodation_coefficient: float=-1, normal_accomodation_coefficient: float=-1, tangential_accomodation_coefficient: float=-1, normal_velocity_at_wall_ratio: float=-1) -> MaterialProperties:
    """No Documentation"""

def merge_body_panel_setting_lists(list_of_lists_of_body_panel_settings: list[list[BodyPanelSettings]]) -> list[BodyPanelSettings]:
...
def time_varying_panel_geometry(surface_normal_function: typing.Callable[[], typing.Annotated[numpy.ndarray, numpy.float64, pybind11_stubgen.typing_ext.FixedSize(3, 1)]], area: float, frame_orientation: str) -> BodyPanelGeometrySettings:
