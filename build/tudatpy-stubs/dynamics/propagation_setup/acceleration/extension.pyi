...
from ....dynamics.propagation_setup import thrust
import typing
...
class AvailableAcceleration:
    ...
    einstein_infeld_hoffmann_acceleration_type: typing.ClassVar[AvailableAcceleration]
    ...
    yarkovsky_acceleration_type: typing.ClassVar[AvailableAcceleration]
...
class ThrustAccelerationSettings(AccelerationSettings):
    ...
    @property
    def direction_settings(self) -> thrust.ThrustDirectionSettings:
        ...

    @property
    def magnitude_settings(self) -> thrust.ThrustMagnitudeSettings:
        ...
...
def custom(acceleration_function: typing.Callable[[float], typing.Annotated[numpy.ndarray, numpy.float64, pybind11_stubgen.typing_ext.FixedSize(3, 1)]]) -> AccelerationSettings:
    ...

def custom_acceleration(acceleration_function: typing.Callable[[float], typing.Annotated[numpy.ndarray, numpy.float64, pybind11_stubgen.typing_ext.FixedSize(3, 1)]]) -> AccelerationSettings:
...
def einstein_infeld_hofmann() -> AccelerationSettings:
...
def empirical(constant_acceleration: typing.Annotated[numpy.ndarray, numpy.float64, pybind11_stubgen.typing_ext.FixedSize(3, 1)]=..., sine_acceleration: typing.Annotated[numpy.ndarray, numpy.float64, pybind11_stubgen.typing_ext.FixedSize(3, 1)]=..., cosine_acceleration: typing.Annotated[numpy.ndarray, numpy.float64, pybind11_stubgen.typing_ext.FixedSize(3, 1)]=...) -> AccelerationSettings:
...
def quasi_impulsive_shots_acceleration(thrust_mid_times: list[float], delta_v_values: list[typing.Annotated[numpy.ndarray, numpy.float64, pybind11_stubgen.typing_ext.FixedSize(3, 1)]], total_maneuver_time: float, maneuver_rise_time: float) -> AccelerationSettings:
...
def radiation_pressure(target_type: radiation_pressure.RadiationPressureTargetModelType=...) -> AccelerationSettings:
...
def relativistic_correction(use_schwarzschild: bool=False, use_lense_thirring: bool=False, use_de_sitter: bool=False, de_sitter_central_body: str='', lense_thirring_angular_momentum: typing.Annotated[numpy.ndarray, numpy.float64, pybind11_stubgen.typing_ext.FixedSize(3, 1)]=...) -> AccelerationSettings:
...
def thrust_and_isp_from_custom_function(thrust_force_function: typing.Callable[[float], typing.Annotated[numpy.ndarray, numpy.float64, pybind11_stubgen.typing_ext.FixedSize(3, 1)]], constant_specific_impulse: float, thrust_frame: thrust.ThrustFrames=..., central_body: str='') -> AccelerationSettings:
...
def thrust_from_custom_function(thrust_force_function: typing.Callable[[float], typing.Annotated[numpy.ndarray, numpy.float64, pybind11_stubgen.typing_ext.FixedSize(3, 1)]], specific_impulse_function: typing.Callable[[float], float], thrust_frame: thrust.ThrustFrames=..., central_body: str='') -> AccelerationSettings:
    ...

def thrust_from_direction_and_magnitude(thrust_direction_settings: thrust.ThrustDirectionSettings, thrust_magnitude_settings: thrust.ThrustMagnitudeSettings) -> AccelerationSettings:
    ...
...
einstein_infeld_hoffmann_acceleration_type: AvailableAcceleration
...
yarkovsky_acceleration_type: AvailableAcceleration