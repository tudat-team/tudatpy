...
from tudatpy.estimation.observations.observation_corrections.photocenter_correction import (
    ...
    apply_photocenter_correction_to_observation_dataset,
)
...
def _build_angular_observation_dataset(observation_pairs, times, body_name, observer_body_name):
    ...
    dataset.add_observation_set(
        ...
        observations.LinkDefinition(link_ends),
...
def test_apply_photocenter_correction_to_observation_dataset(in_place):
    ...
    dataset = _build_angular_observation_dataset(
    ...
    with patch(
        ...
        result = apply_photocenter_correction_to_observation_dataset(
    ...
    np.testing.assert_allclose(np.asarray(target_dataset.get_observations()), expected_observations)
