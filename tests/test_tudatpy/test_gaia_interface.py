"""
Tests for the Gaia interfaces in tudatpy.data.gaia.gaia.
"""
...
def test_apply_corrections_photocenter(gaia_astrometry):
    ...
    with mock.patch(
        "tudatpy.data.gaia.gaia.photocenter_correction_angular_observations",
...
def test_apply_corrections_light_deflection(gaia_astrometry):
    ...
    with mock.patch(
        "tudatpy.data.gaia.gaia.light_deflection_correction_angular_observations",
        side_effect=fake_correction,
    ):
