...
from tudatpy.data_access.tracking.processTrk234TrackingData.processor import (
    Trk234TrackingDataProcessor,
)
from tudatpy.data_access.tracking.processTrk234TrackingData import converters as cnv
from tudatpy.data_access.tracking.processTrk234TrackingData import OpenRampHandling


# -----------------------------------------------------------------------------
# Ramp converter tests (RampConverter logic is unchanged from processTrk234)
# -----------------------------------------------------------------------------
...
def test_reader():
    ...
    trkProcessor = Trk234TrackingDataProcessor(
        [local_filename],
        ["doppler"],
        spacecraft_name="-202",
    )
    ...
    # trkProcessor.set_transponder_turnaround_ratio(bodies) This requires tudatpy to be compiled with time scalar type tudat::Time
