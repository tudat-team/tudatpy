...
PropagationHistory getMelmanBenchmarkData( )
{
    ...
    stateInKeplerianElements = convertCartesianToKeplerianElements( stateInCartesianElements, getMelmanEarthGravitationalParameter( ) );
    benchmarkPropagationHistory[ 0.0 ] = stateInKeplerianElements;

    stateInCartesianElements << -6.1318272067e6, 5.1974105627e6, 0.0, -4.7375063953e3, -4.8565484865e3, 0.0;
    stateInKeplerianElements = convertCartesianToKeplerianElements( stateInCartesianElements, getMelmanEarthGravitationalParameter( ) );
...
PropagationHistory getODTBXBenchmarkData( )
{
    ...
    stateInKeplerianElements << 42165.3431351313e3, 0.26248354351331, 0.30281462522101, 4.71463172847351, 4.85569272927819,
            2.37248926702153;
...
PropagationHistory getGTOPBenchmarkData( )
{
    ...
    stateInKeplerianElements = convertCartesianToKeplerianElements( stateInCartesianElements, getGTOPGravitationalParameter( ) );
    benchmarkPropagationHistory[ 0.0 ] = stateInKeplerianElements;

    stateInCartesianElements << 50369576778.98602, 453006898372.5074, 2.156946592732799e-005, -14654.13750690802, 46884.94068619227,
            4.665334803219454e-012;
    stateInKeplerianElements = convertCartesianToKeplerianElements( stateInCartesianElements, getGTOPGravitationalParameter( ) );
    benchmarkPropagationHistory[ 8640000.0 ] = stateInKeplerianElements;

    stateInCartesianElements << -76810236076.38216, 842661848023.4473, 6.100268297443444e-005, -14683.57015580225, 43917.12010513522,
            4.48721854707566e-012;
    stateInKeplerianElements = convertCartesianToKeplerianElements( stateInCartesianElements, getGTOPGravitationalParameter( ) );
    benchmarkPropagationHistory[ 8640000.0 * 2.0 ] = stateInKeplerianElements;

    stateInCartesianElements << -203052258817.9893, 1216808019495.603, 9.937145023346651e-005, -14543.34378775917, 42828.66589049961,
            4.403399939593385e-012;
    stateInKeplerianElements = convertCartesianToKeplerianElements( stateInCartesianElements, getGTOPGravitationalParameter( ) );
    benchmarkPropagationHistory[ 8640000.0 * 3.0 ] = stateInKeplerianElements;

    stateInCartesianElements << -328225472457.8796, 1584186440047.591, 0.0001371949389119038, -14437.813524927732, 42264.20425643964,
            4.355914471377053e-012;
    stateInKeplerianElements = convertCartesianToKeplerianElements( stateInCartesianElements, getGTOPGravitationalParameter( ) );
