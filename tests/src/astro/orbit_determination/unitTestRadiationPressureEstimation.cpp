...
//        bodyWingPanelledGeometry( 2.0, 3.0, 4.0, 20.0, 0.1, 0.4, 0.2, 0.15, false, false ),
//        "Vehicle", bodies );
//
...
//            std::make_shared< RadiationPressureTargetModelSettings >( paneled_target ), "Vehicle", bodies ) } );
    ...
    panels = {
        ...
        std::make_shared< system_models::VehicleExteriorPanel >(9.9, Eigen::Vector3d::UnitY(),
                                                                reflectionLawFromSpecularAndDiffuseReflectivity(0.35, 0.2)),
    };
    ...
    parameterNames.push_back(std::make_shared<EstimatableParameterSettings>("Vehicle", specular_reflectivity, "SolarPanel") );
    parameterNames.push_back(std::make_shared<EstimatableParameterSettings>("Vehicle", diffuse_reflectivity, "SolarPanel") );
//    parameterNames.push_back(std::make_shared<EstimatableParameterSettings>("Vehicle", specular_reflectivity, "SolarPanel") );
//    parameterNames.push_back(std::make_shared<EstimatableParameterSettings>("Vehicle", diffuse_reflectivity, "SolarPanel") );
    ...
    measurementSimulationInput.push_back( std::make_shared< TabulatedObservationSimulationSettings< > >( position_observable, linkEnds, baseTimeList, observed_body));
    ...
    parameterPerturbation.segment( 6, 1 ) = Eigen::Vector1d::Constant( 0.2 );
//    parameterPerturbation.segment( 7, 1 ) = Eigen::Vector1d::Constant( 0.2 );
