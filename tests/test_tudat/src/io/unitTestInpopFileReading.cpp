...
BOOST_AUTO_TEST_CASE( test_inpop_time_ephemeris )
{
    ...
    BOOST_CHECK_SMALL( timeEphemerisInterpolator->interpolate(
                               ( basic_astrodynamics::TAI_JULIAN_DAY_AT_TIME_SYNCHRONIZATION - basic_astrodynamics::JULIAN_DAY_ON_J2000 ) *
...
BOOST_AUTO_TEST_CASE( test_inpop_time_ephemeris2 )
{
    ...
    BOOST_CHECK_SMALL( sofa_interface::getTDBminusTT( 1.0E7, 0.0, 0.0, 0.0, 0.0 ) + timeEphemerisInterpolator->interpolate( 1.0E7 ),
                       5.0E-9 );
}
...
BOOST_AUTO_TEST_CASE( test_inpop_state_ephemeris )
{
    ...
    Eigen::Vector6d spiceKernelState =
            spice_interface::getBodyCartesianStateAtEpoch( "Earth", "SSB", "J2000", "NONE", basic_astrodynamics::convertTcbToTdb( 0.0 ) );
