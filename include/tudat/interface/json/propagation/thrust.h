...
<<<<<<< HEAD
//static std::map< reference_frames::StateReferenceFrames, std::string > thrustFrameTypes =
//{
//    { unspecified_reference_frame, "unspecified" },
//    { inertial_thurst_frame, "intertial" },
//    { tnw_reference_frame, "tnw" }
//};

////! `ThrustFrames` not supported by `json_interface`.
//static std::vector< reference_frames::StateReferenceFrames > unsupportedThrustFrameTypes =
//{
//    unspecified_reference_frame
//};

//! Convert `ThrustFrames` to `json`.
inline void to_json( nlohmann::json& jsonObject, const reference_frames::SatelliteReferenceFrames& thrustFrameType )
{
    jsonObject = json_interface::stringFromEnum( thrustFrameType, thrustFrameTypes );
}

//! Convert `json` to `ThrustFrames`.
inline void from_json( const nlohmann::json& jsonObject, reference_frames::SatelliteReferenceFrames& thrustFrameType )
{
