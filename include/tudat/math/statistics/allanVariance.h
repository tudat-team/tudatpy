 ...
 * variance is calculated at a time interval of an integer multiple of the time interval between two entries of the input vector.
 ...
 * variance can be calculated at a time interval of an integer multiple of the time interval between two entries of the input vector.
