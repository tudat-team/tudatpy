...
public:
            ...
            const std::shared_ptr< ObservationAncillarySimulationSettings > ancillarySettings = nullptr ) override
    {
        ...
        const double downlinkReferenceCarrierFrequency = static_cast< double >( currentReferenceTurnAroundRatio * referenceFrequency );
        ancillarySettings->setAncillaryDoubleData( observation_models::doppler_conversion_factor,
        ...
        TimeType receptionTdbEndTime = timeScaleConverter_->template getCurrentTime< TimeType >(
