...
public:
    ...
    PolyhedronGravitationalAccelerationModel(
        ...
        gravitationalParameterFunction_( [ =, this ]( ) { return aGravitationalParameter; } ), volumeFunction_( [ =, this ]( ) { return aVolume; } ),
        getVerticesCoordinates_( [ =, this ]( ) { return aVerticesCoordinatesMatrix; } ),
        getVerticesDefiningEachFacet_( [ =, this ]( ) { return aVerticesDefiningEachFacetMatrix; } ),
        getVerticesDefiningEachEdge_( [ =, this ]( ) { return aVerticesDefiningEachEdgeMatrix; } ),
        getFacetDyads_( [ =, this ]( ) { return aFacetDyadsVector; } ), getEdgeDyads_( [ =, this ]( ) { return aEdgeDyadsVector; } ),
