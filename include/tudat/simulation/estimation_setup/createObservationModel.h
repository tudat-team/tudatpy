...
class ConstantObservationBiasSettings : public ObservationBiasSettings
{
   public:
     ...
     */
    ConstantObservationBiasSettings( const Eigen::VectorXd& observationBias,
                                     const bool useAbsoluteBias ) :
        ObservationBiasSettings( ( useAbsoluteBias == true ) ? ( constant_absolute_bias )
...
class ArcWiseConstantObservationBiasSettings : public ObservationBiasSettings
{
   public:
    ...
    ArcWiseConstantObservationBiasSettings( const std::vector< double >& arcStartTimes,
        ...
        arcStartTimes_( arcStartTimes ), observationBiases_( observationBiases ),
        linkEndForTime_( linkEndForTime ), useAbsoluteBias_( useAbsoluteBias )
    { }
    ...
    ArcWiseConstantObservationBiasSettings(
        ...
        observationBiases_( utilities::createVectorFromMapValues( observationBiases ) ),
        linkEndForTime_( linkEndForTime ), useAbsoluteBias_( useAbsoluteBias )
    { }
...
class ConstantTimeDriftBiasSettings : public ObservationBiasSettings
{
   public:
     ...
     * initialised.
     */
    ConstantTimeDriftBiasSettings( const Eigen::VectorXd& timeDriftBias,
                                   const LinkEndType linkEndForTime,
                                   const double referenceEpoch ) :
        ObservationBiasSettings( constant_time_drift_bias ), timeDriftBias_( timeDriftBias ),
        linkEndForTime_( linkEndForTime ), referenceEpoch_( referenceEpoch )
    { }
...
class ArcWiseTimeDriftBiasSettings : public ObservationBiasSettings
{
   public:
    ...
    ArcWiseTimeDriftBiasSettings( const std::vector< double >& arcStartTimes,
        ...
        ObservationBiasSettings( arc_wise_time_drift_bias ), arcStartTimes_( arcStartTimes ),
        timeDriftBiases_( timeDriftBiases ), linkEndForTime_( linkEndForTime ),
    ...
    ArcWiseTimeDriftBiasSettings( const std::map< double, Eigen::VectorXd >& timeDriftBiases,
        ...
        timeDriftBiases_( utilities::createVectorFromMapValues( timeDriftBiases ) ),
...
class ConstantTimeBiasSettings : public ObservationBiasSettings
{
   public:
    ...
    ConstantTimeBiasSettings( const double timeBias, const LinkEndType linkEndForTime ) :
        ObservationBiasSettings( constant_time_bias ), timeBias_( timeBias ),
...
class ArcWiseTimeBiasSettings : public ObservationBiasSettings
{
   public:
    ...
    ArcWiseTimeBiasSettings( const std::vector< double >& arcStartTimes,
                             ...
                             const LinkEndType linkEndForTime ) :
        ObservationBiasSettings( arc_wise_time_bias ), arcStartTimes_( arcStartTimes ),
        timeBiases_( timeBiases ), linkEndForTime_( linkEndForTime )
    { }
     ...
     */
    ArcWiseTimeBiasSettings( const std::map< double, double >& timeBiases,
                             const LinkEndType linkEndForTime ) :
        ObservationBiasSettings( arc_wise_time_bias ),
        arcStartTimes_( utilities::createVectorFromMapKeys( timeBiases ) ),
        timeBiases_( utilities::createVectorFromMapValues( timeBiases ) ),
        linkEndForTime_( linkEndForTime )
    { }
...
class TiminigSystemBiasSettings : public ObservationBiasSettings
{
   public:
    ...
    TiminigSystemBiasSettings( const std::string& bodyName, const std::string& stationName ) :
        ObservationBiasSettings( clock_induced_bias ), bodyName_( bodyName ),
...
inline std::shared_ptr< ObservationBiasSettings > clockInducedBias( const std::string& bodyName,
...
inline std::shared_ptr< ObservationBiasSettings > constantTimeDriftBias(
        ...
        const double referenceEpoch )
{
    return std::make_shared< ConstantTimeDriftBiasSettings >(
            timeDriftBias, linkEndForTime, referenceEpoch );
}
        ...
        const std::vector< double >& referenceEpochs )
{
    return std::make_shared< ArcWiseTimeDriftBiasSettings >(
            arcStartTimes, timeDriftBiases, linkEndForTime, referenceEpochs );
}
...
{
    return std::make_shared< ArcWiseTimeDriftBiasSettings >(
            timeDriftBiases, linkEndForTime, referenceEpochs );
}
...
class ObservationModelSettings
{
   public:
    ...
    ObservationModelSettings(
        ...
        lightTimeCorrectionsList_( lightTimeCorrectionsList ), biasSettings_( biasSettings ),
        lightTimeConvergenceCriteria_( lightTimeConvergenceCriteria )
    { }
...
class OneWayDopplerObservationSettings : public ObservationModelSettings
{
   public:
    ...
    OneWayDopplerObservationSettings(
            const LinkDefinition& linkEnds,
            const std::shared_ptr< LightTimeCorrectionSettings > lightTimeCorrections,
            const std::shared_ptr< DopplerProperTimeRateSettings >
                    transmitterProperTimeRateSettings = nullptr,
            const std::shared_ptr< DopplerProperTimeRateSettings > receiverProperTimeRateSettings =
                    nullptr,
            const std::shared_ptr< ObservationBiasSettings > biasSettings = nullptr,
            const std::shared_ptr< LightTimeConvergenceCriteria > lightTimeConvergenceCriteria =
                    std::make_shared< LightTimeConvergenceCriteria >( ),
            const bool normalizeWithSpeedOfLight = false ) :
        ObservationModelSettings( one_way_doppler,
                                  linkEnds,
   ...
   public:
        ...
        downlinkOneWayDopplerSettings_( downlinkOneWayDopplerSettings )
    {
        ...
        if( uplinkOneWayDopplerSettings->normalizeWithSpeedOfLight_ !=
            downlinkOneWayDopplerSettings->normalizeWithSpeedOfLight_ )
        {
...
class DsnNWayAveragedDopplerObservationSettings : public ObservationModelSettings
{
   public:
    DsnNWayAveragedDopplerObservationSettings(
        ...
        ObservationModelSettings( dsn_n_way_averaged_doppler,
                                  linkEnds,
                                  lightTimeCorrectionsList,
                                  biasSettings ),
        multiLegLightTimeConvergenceCriteria_( lightTimeConvergenceCriteria ),
...
inline std::shared_ptr< ObservationModelSettings > oneWayRangeSettings(
        ...
        const std::shared_ptr< LightTimeConvergenceCriteria > lightTimeConvergenceCriteria =
                std::make_shared< LightTimeConvergenceCriteria >( ) )
{
    return std::make_shared< ObservationModelSettings >( one_way_range,
                                                         linkEnds,
                                                         lightTimeCorrectionsList,
                                                         biasSettings,
                                                         lightTimeConvergenceCriteria );
...
inline std::shared_ptr< ObservationModelSettings > twoWayOpenLoopDoppler(
        ...
        const bool normalizeWithSpeedOfLight = false )
{
    return std::make_shared< TwoWayDopplerObservationSettings >( linkEnds,
                                                                 lightTimeCorrectionsList,
                                                                 biasSettings,
                                                                 lightTimeConvergenceCriteria,
                                                                 normalizeWithSpeedOfLight );
...
inline std::shared_ptr< ObservationModelSettings > dopplerMeasuredFrequencyObservationSettings(
        ...
        const std::shared_ptr< LightTimeConvergenceCriteria > lightTimeConvergenceCriteria =
                std::make_shared< LightTimeConvergenceCriteria >( ) )
{
    return std::make_shared< ObservationModelSettings >( doppler_measured_frequency,
                                                         linkEnds,
                                                         lightTimeCorrectionsList,
                                                         biasSettings,
                                                         lightTimeConvergenceCriteria );
    ...
    const std::shared_ptr< LightTimeConvergenceCriteria > lightTimeConvergenceCriteria = std::make_shared< LightTimeConvergenceCriteria >( ) )
{
    ...
    {
        std::shared_ptr< OneWayDopplerObservationSettings > uplinkOneWaySettings = std::make_shared< OneWayDopplerObservationSettings >(
            getUplinkFromTwoWayLinkEnds( linkEnds ), lightTimeCorrectionsList, properTimeRateSettings, properTimeRateSettings, nullptr, lightTimeConvergenceCriteria );
        uplinkOneWaySettings->normalizeWithSpeedOfLight_ = false;

        std::shared_ptr< OneWayDopplerObservationSettings > downlinkOneWaySettings = std::make_shared< OneWayDopplerObservationSettings >(
            getDownlinkFromTwoWayLinkEnds( linkEnds ), lightTimeCorrectionsList, properTimeRateSettings, properTimeRateSettings, nullptr, lightTimeConvergenceCriteria );
        downlinkOneWaySettings->normalizeWithSpeedOfLight_ = false;

        return std::make_shared< TwoWayDopplerObservationSettings >( uplinkOneWaySettings, downlinkOneWaySettings, doppler_measured_frequency, biasSettings );
    }
    else
    {
        return std::make_shared<ObservationModelSettings>( doppler_measured_frequency,
...
inline std::shared_ptr< ObservationModelSettings > oneWayClosedLoopDoppler(
        ...
        const std::shared_ptr< LightTimeConvergenceCriteria > lightTimeConvergenceCriteria =
                std::make_shared< LightTimeConvergenceCriteria >( ) )
{
    return std::make_shared< ObservationModelSettings >( one_way_differenced_range,
                                                         linkEnds,
                                                         lightTimeCorrectionsList,
                                                         biasSettings,
                                                         lightTimeConvergenceCriteria );
        ...
        const std::shared_ptr< ObservationBiasSettings > biasSettings = nullptr )
{
    ...
    return std::make_shared< NWayDifferencedRangeObservationSettings >(
            oneWayRangeObservationSettings, biasSettings );
}
        ...
        const std::shared_ptr< ObservationBiasSettings > biasSettings = nullptr )
{
    ...
    {
        throw std::runtime_error(
                "Error when creating two-way range settings, number of input one-way links (" +
                std::to_string( oneWayRangeObservationSettings.size( ) ) + ") is incompatible." );
    }
    return std::make_shared< NWayRangeObservationSettings >( oneWayRangeObservationSettings,
                                                             biasSettings );
}
                ...
                std::make_shared< LightTimeConvergenceCriteria >( ) )
{
    ...
    {
        throw std::runtime_error(
                "Error when creating two-way range settings, number of input link ends (" +
                std::to_string( linkEnds.linkEnds_.size( ) ) + ") is incompatible." );
    }
    return std::make_shared< NWayRangeObservationSettings >(
            linkEnds, lightTimeCorrectionsList, biasSettings, lightTimeConvergenceCriteria );
...
{
    return std::make_shared< LightTimeConvergenceCriteria >( iterateCorrections,
                                                             maximumNumberOfIterations,
                                                             fractionOfLightTimeTolerance,
                                                             failureHandling );
}
    ...
    case direct_first_order_doppler_proper_time_rate:
    {
        ...
        else
        {
            ...
            for ( unsigned int i = 0; i < directFirstOrderDopplerProperTimeRateSettings->centralBodyNames_.size( ); i++ )
            {
                ...
                LinkEndId perturberLinkEndId = LinkEndId(
                    currentBodyName, "" );
                if (( linkEnds.at( receiver ) == perturberLinkEndId ) || ( linkEnds.at( transmitter ) == perturberLinkEndId ))
                {
                    throw std::runtime_error(
                        "Error, proper time reference point is identical perturbed point; DopplerProperTimeRateInterface will yield Inf dtau/dt" );
                }
                ...
                {
                    throw std::runtime_error(
                        "Error when making DopplerProperTimeRateInterface, body has not gravity field "  +
                ...
                perturbingBodyStateFunctions.push_back(
                    std::bind( &simulation_setup::Body::getStateInBaseFrameFromEphemeris<double, double>,
                               bodies.at( currentBodyName ), std::placeholders::_1 ));
...
std::map< ObservableType, std::vector< std::shared_ptr< ObservationModelSettings > > >
        ...
        const simulation_setup::SystemOfBodies& bodies )
{
    ...
    switch( biasSettings->observationBiasType_ )
    {
        case constant_absolute_bias: {
            ...
            {
                throw std::runtime_error(
                        "Error when making constant observation bias, settings are inconsistent" );
            }
            ...
            {
                throw std::runtime_error(
                        "Error when making constant observation bias, bias size is inconsistent" );
            }
        ...
        case arc_wise_constant_absolute_bias: {
            ...
            {
                throw std::runtime_error(
                        "Error when making arc-wise observation bias, settings are inconsistent" );
            }
        ...
        case constant_relative_bias: {
            ...
            observationBias =
                    std::make_shared< ConstantRelativeObservationBias< ObservationSize > >(
                            constantBiasSettings->observationBias_ );
            break;
        }
        case arc_wise_constant_relative_bias: {
            ...
            observationBias =
                    std::make_shared< ConstantRelativeArcWiseObservationBias< ObservationSize > >(
                            arcwiseBiasSettings->arcStartTimes_,
                            observationBiases,
                            observation_models::getLinkEndIndicesForLinkEndTypeAtObservable(
                                    observableType,
                                    arcwiseBiasSettings->linkEndForTime_,
                                    linkEnds.size( ) )
                                    .at( 0 ) );
            break;
        }
        case constant_time_drift_bias: {
            ...
            observationBias = std::make_shared< ConstantTimeDriftBias< ObservationSize > >(
                    ...
                    observation_models::getLinkEndIndicesForLinkEndTypeAtObservable(
                            observableType,
                            constantTimeDriftBiasSettings->linkEndForTime_,
                            linkEnds.size( ) )
                            .at( 0 ),
        ...
        case arc_wise_time_drift_bias: {
            ...
            {
                throw std::runtime_error(
                        "Error when making arc-wise time drift bias, settings are inconsistent" );
            }
        ...
        case constant_time_bias: {
            ...
            observationBias = std::make_shared< ConstantTimeBias< ObservationSize > >(
                    ...
                    observation_models::getLinkEndIndicesForLinkEndTypeAtObservable(
                            observableType,
                            constantTimeBiasSettings->linkEndForTime_,
                            linkEnds.size( ) )
                            .at( 0 ) );
            break;
        }
        case arc_wise_time_bias: {
            ...
            {
                throw std::runtime_error(
                        "Error when making arc-wise time bias, settings are inconsistent" );
            }
        ...
        case multiple_observation_biases: {
            ...
            std::vector< std::shared_ptr< ObservationBias< ObservationSize > > >
                    observationBiasList;
            for( unsigned int i = 0; i < multiBiasSettings->biasSettingsList_.size( ); i++ )
            {
                observationBiasList.push_back( createObservationBiasCalculator< ObservationSize >(
                        linkEnds,
                        observableType,
                        multiBiasSettings->biasSettingsList_.at( i ),
                        bodies ) );
            }
        ...
        case clock_induced_bias: {
            ...
            else
            {
                ...
                std::vector< int > relevantLinkEndIndices =
                        getLinkEndIndicesForLinkEndIdAtObservable(
                                observableType,
                                linkEnds.linkEnds_,
                                LinkEndId( clockInducedBiasSettings->bodyName_,
                                           clockInducedBiasSettings->stationName_ ) );

                if( clockInducedBiasSettings == nullptr )
                {
                    throw std::runtime_error(
                            "Error when making clock-induced bias, settings are inconsistent" );
                }
                ...
                else
                {
                    if( clockInducedBiasSettings->stationName_ == "" )
                    {
                        ...
                        {
                            throw std::runtime_error(
                                    "Error when getting timing system of body " +
                                    clockInducedBiasSettings->bodyName_ +
...
getTurnaroundFunction( const simulation_setup::SystemOfBodies& bodies, const LinkEnds& linkEnds );

std::shared_ptr< ground_stations::StationFrequencyInterpolator >
getTransmittingFrequencyInterpolator( const simulation_setup::SystemOfBodies& bodies,
...
class ObservationModelCreator
{
   public:
     ...
     */
    static std::shared_ptr< observation_models::ObservationModel< ObservationSize,
...
class ObservationModelCreator< 1, ObservationScalarType, TimeType >
{
   public:
    ...
    static std::shared_ptr<
            observation_models::ObservationModel< 1, ObservationScalarType, TimeType > >
    createObservationModel( const std::shared_ptr< ObservationModelSettings > observationSettings,
                            const simulation_setup::SystemOfBodies& bodies,
                            ObservableType topLevelObservableType = undefined_observation_model )
    {
        ...
        case one_way_range: {
            ...
            if( linkEnds.size( ) != 2 )
            {
                std::string errorMessage = "Error when making 1 way range model, " +
            ...
            {
                throw std::runtime_error(
                    "Error when making 1 way range model, no receiver found" );
            }
            if( linkEnds.count( transmitter ) == 0 )
            {
                throw std::runtime_error(
                    "Error when making 1 way range model, no transmitter found" );
            }
            ...
            {
                observationBias =
                    createObservationBiasCalculator( linkEnds,
        ...
        case one_way_doppler: {
            ...
            if( linkEnds.size( ) != 2 )
            {
                std::string errorMessage = "Error when making 1 way Doppler model, " +
                                           std::to_string( linkEnds.size( ) ) + " link ends found";
                throw std::runtime_error( errorMessage );
            }
            if( linkEnds.count( receiver ) == 0 )
            {
                throw std::runtime_error(
                    "Error when making 1 way Doppler model, no receiver found" );
            }
            if( linkEnds.count( transmitter ) == 0 )
            {
                throw std::runtime_error(
                    "Error when making 1 way Doppler model, no transmitter found" );
            }
            ...
            if( std::dynamic_pointer_cast< OneWayDopplerObservationSettings >(
                observationSettings ) == nullptr )
            {
                // Create observation model
                observationModel = std::make_shared<
                    OneWayDopplerObservationModel< ObservationScalarType, TimeType > >(
                    linkEnds,
                    createLightTimeCalculator< ObservationScalarType, TimeType >(
                        linkEnds,
                        transmitter,
            ...
            else
            {
                std::shared_ptr< OneWayDopplerObservationSettings > oneWayDopplerSettings =
                    std::dynamic_pointer_cast< OneWayDopplerObservationSettings >(
                        observationSettings );
                std::shared_ptr< DopplerProperTimeRateInterface > transmitterProperTimeRate =
                    nullptr;
                std::shared_ptr< DopplerProperTimeRateInterface > receiverProperTimeRate =
                    nullptr;
                if( oneWayDopplerSettings->transmitterProperTimeRateSettings_ != nullptr )
                {
                    transmitterProperTimeRate =
                        createOneWayDopplerProperTimeCalculator< ObservationScalarType,
                            TimeType >(
                            oneWayDopplerSettings->transmitterProperTimeRateSettings_,
                            linkEnds,
                            bodies,
                            transmitter );
                }
                ...
                if( oneWayDopplerSettings->receiverProperTimeRateSettings_ != nullptr )
                {
                    receiverProperTimeRate =
                        createOneWayDopplerProperTimeCalculator< ObservationScalarType,
                            TimeType >(
                            oneWayDopplerSettings->receiverProperTimeRateSettings_,
                            linkEnds,
                            bodies,
                            receiver );
                }
        ...
        case two_way_doppler:
        {
            ...
            if( linkEnds.size( ) != 3 )
            {
                std::string errorMessage = "Error when making 2 way Doppler model, " +
                                           std::to_string( linkEnds.size( ) ) + " link ends found";
                throw std::runtime_error( errorMessage );
            }
            if( linkEnds.count( receiver ) == 0 )
            {
                throw std::runtime_error(
                    "Error when making 2 way Doppler model, no receiver found" );
            }

            if( linkEnds.count( reflector1 ) == 0 )
            {
                throw std::runtime_error(
                    "Error when making 2 way Doppler model, no retransmitter found" );
            }

            if( linkEnds.count( transmitter ) == 0 )
            {
                throw std::runtime_error(
                    "Error when making 2 way Doppler model, no transmitter found" );
            }
        ...
        case one_way_differenced_range:
        {
            ...
            // Create observation model
            observationModel = std::make_shared<
                OneWayDifferencedRangeObservationModel< ObservationScalarType, TimeType > >(
                linkEnds,
                createLightTimeCalculator< ObservationScalarType, TimeType >(
                    linkEnds,
                    transmitter,
        ...
        case n_way_range: {
            ...
            if( linkEnds.size( ) < 2 )
            {
                std::string errorMessage = "Error when making n way range model, " +
                                           std::to_string( linkEnds.size( ) ) + " link ends found";
                throw std::runtime_error( errorMessage );
            }
            ...
            std::shared_ptr< NWayRangeObservationSettings > nWayRangeObservationSettings =
                std::dynamic_pointer_cast< NWayRangeObservationSettings >(
                    observationSettings );
            if( nWayRangeObservationSettings != nullptr &&
                nWayRangeObservationSettings->oneWayRangeObservationSettings_.size( ) !=
                linkEnds.size( ) - 1 )
            {
                throw std::runtime_error(
                    "Error when making n-way range, input data is inconsistent" );
            }

            // Create vector of convergence criteria and light time corrections
            std::vector< std::shared_ptr< LightTimeConvergenceCriteria > >
                singleLegsLightTimeConvergenceCriteriaList;
            std::shared_ptr< LightTimeConvergenceCriteria >
            ...
            if( nWayRangeObservationSettings != nullptr )
            {
                ...
                for( unsigned int i = 0; i < linkEnds.size( ) - 1; i++ )
                {
                    if( nWayRangeObservationSettings->oneWayRangeObservationSettings_.at( i )
                            ->observableType_ != one_way_range )
                    {
                        throw std::runtime_error(
                    ...
                    lightTimeCorrectionsList.push_back(
                        nWayRangeObservationSettings->oneWayRangeObservationSettings_
                            .at( i )
            ...
            std::shared_ptr<
                ...
                createMultiLegLightTimeCalculator< ObservationScalarType,
                    TimeType >(
                    linkEnds,
                    bodies,
                    topLevelObservableType,
        ...
        case n_way_differenced_range: {
            std::shared_ptr< NWayDifferencedRangeObservationSettings >
                nWayDifferencedRangeObservationSettings = std::dynamic_pointer_cast<
                NWayDifferencedRangeObservationSettings >( observationSettings );
            ...
            try
            {
                std::shared_ptr< ObservationModelSettings > undifferencedObservationSettings =
                    nWayDifferencedRangeObservationSettings
                        ->getUndifferencedObservationSettings( );

                arcStartObservationModel = std::dynamic_pointer_cast<
                    NWayRangeObservationModel< ObservationScalarType, TimeType > >(
                    ObservationModelCreator< 1, ObservationScalarType, TimeType >::
                    createObservationModel( undifferencedObservationSettings,
                                            bodies,
                                            topLevelObservableType ) );
                arcEndObservationModel = std::dynamic_pointer_cast<
                    NWayRangeObservationModel< ObservationScalarType, TimeType > >(
                    ObservationModelCreator< 1, ObservationScalarType, TimeType >::
                    createObservationModel( undifferencedObservationSettings,
                                            bodies,
            ...
            observationModel = std::make_shared<
                NWayDifferencedRangeObservationModel< ObservationScalarType, TimeType > >(
                linkEnds,
                arcStartObservationModel,
                arcEndObservationModel,
                observationBias );
        ...
        case dsn_n_way_averaged_doppler: {
            ...
            try
            {
                std::shared_ptr< ObservationModelSettings > nWayRangeObservationSettings =
                    dsnNWayAveragedDopplerObservationSettings
                        ->getNWayRangeObservationSettings( );

                arcStartObservationModel = std::dynamic_pointer_cast<
                    NWayRangeObservationModel< ObservationScalarType, TimeType > >(
                    ObservationModelCreator< 1, ObservationScalarType, TimeType >::
                    createObservationModel( nWayRangeObservationSettings,
                                            bodies,
                                            topLevelObservableType ) );
                arcEndObservationModel = std::dynamic_pointer_cast<
                    NWayRangeObservationModel< ObservationScalarType, TimeType > >(
            ...
            std::function< double( observation_models::FrequencyBands,
                                   observation_models::FrequencyBands ) >
            ...
            for( auto it: linkEnds )
            {
                        ...
                        .count( linkEnds.at( it.first ).stationName_ ) > 0 )
                {
                    stationStates[ it.first ] =
                        bodies.at( linkEnds.at( it.first ).bodyName_ )
            ...
            observationModel = std::make_shared<
                ...
                bodies.getBody( linkEnds.at( observation_models::transmitter ).bodyName_ )
                    ->getGroundStation( linkEnds.at( observation_models::transmitter )
                                            .stationName_ )
        ...
        case dsn_n_way_range:
        {
            std::shared_ptr< DsnNWayRangeObservationSettings > dsnNWayRangeObservationSettings =
                std::dynamic_pointer_cast< DsnNWayRangeObservationSettings >(
                    observationSettings );
            if( dsnNWayRangeObservationSettings != nullptr &&
                dsnNWayRangeObservationSettings->oneWayRangeObservationSettings_.size( ) !=
                linkEnds.size( ) - 1 )
            {
                throw std::runtime_error(
                    "Error when making DSN N-way range, input data is inconsistent" );
            }
            ...
            try
            {
                ...
                if( dsnNWayRangeObservationSettings != nullptr )
                {
                    multiLegLightTimeConvergenceCriteria =
                        dsnNWayRangeObservationSettings
                            ->multiLegLightTimeConvergenceCriteria_;
                    for( unsigned int i = 0; i < linkEnds.size( ) - 1; i++ )
                    {
                        if( dsnNWayRangeObservationSettings->oneWayRangeObservationSettings_
                                .at( i )
                                ->observableType_ != one_way_range )
                        {
                            throw std::runtime_error(
                        ...
                        lightTimeCorrectionsList.push_back(
                            dsnNWayRangeObservationSettings->oneWayRangeObservationSettings_
                                .at( i )
                                ->lightTimeCorrectionsList_ );
                        singleLegsLightTimeConvergenceCriteriaList.push_back(
                            dsnNWayRangeObservationSettings->oneWayRangeObservationSettings_
                ...
                for( auto it: linkEnds )
                {
                            ...
                            .count( linkEnds.at( it.first ).stationName_ ) > 0 )
                    {
                        stationStates[ it.first ] =
                            bodies.at( linkEnds.at( it.first ).bodyName_ )
                                ->getGroundStation(
                                    linkEnds.at( it.first ).stationName_ )
                                ->getNominalStationState( );
                    }
                }
            ...
            catch( const std::exception& caughtException )
            {
                std::string exceptionText = std::string( caughtException.what( ) );
                throw std::runtime_error(
                    "Error when creating DSN N-way range observation model, error: " +
                    exceptionText );
            }
            break;
        }
        case doppler_measured_frequency:
        {
            ...
            try
            {
                ...
                else
                {
                    ...
                    uplinkOneWayDopplerSettings->normalizeWithSpeedOfLight_ = false;
                    downlinkOneWayDopplerSettings = std::make_shared< OneWayDopplerObservationSettings >(
                        getDownlinkFromTwoWayLinkEnds( linkEnds ), observationSettings->lightTimeCorrectionsList_, nullptr, nullptr );
                    downlinkOneWayDopplerSettings->normalizeWithSpeedOfLight_ = false;

                }
                std::shared_ptr< ObservationModelSettings > twoWaySettings =
                    std::make_shared< TwoWayDopplerObservationSettings >( uplinkOneWayDopplerSettings, downlinkOneWayDopplerSettings, two_way_doppler );
        ...
        default:
            std::string errorMessage = "Error, observable " +
                                       std::to_string( observationSettings->observableType_ ) +
...
class ObservationModelCreator< 2, ObservationScalarType, TimeType >
{
   public:
     ...
     */
    static std::shared_ptr<
            observation_models::ObservationModel< 2, ObservationScalarType, TimeType > >
    createObservationModel( const std::shared_ptr< ObservationModelSettings > observationSettings,
                            const simulation_setup::SystemOfBodies& bodies,
                            ObservableType topLevelObservableType = undefined_observation_model )
    {
        ...
        switch( observationSettings->observableType_ )
        {
            case angular_position: {
                ...
                if( linkEnds.size( ) != 2 )
                {
                    std::string errorMessage = "Error when making angular position model, " +
                            std::to_string( linkEnds.size( ) ) + " link ends found";
                    throw std::runtime_error( errorMessage );
                }
                if( linkEnds.count( receiver ) == 0 )
                {
                    throw std::runtime_error(
                            "Error when making angular position model, no receiver found" );
                }
                if( linkEnds.count( transmitter ) == 0 )
                {
                    throw std::runtime_error(
                            "Error when making angular position model, no transmitter found" );
                }
                ...
                // Create observation model
                observationModel = std::make_shared<
                        AngularPositionObservationModel< ObservationScalarType, TimeType > >(
                        linkEnds,
                        createLightTimeCalculator< ObservationScalarType, TimeType >(
                                linkEnds,
                                transmitter,
            ...
            case relative_angular_position: {
                ...
                // Create observation model
                observationModel = std::make_shared<
                        RelativeAngularPositionObservationModel< ObservationScalarType,
                                                                 TimeType > >(
                        linkEnds,
                        createLightTimeCalculator< ObservationScalarType, TimeType >(
                                linkEnds,
...
class ObservationModelCreator< 3, ObservationScalarType, TimeType >
{
   public:
     ...
     */
    static std::shared_ptr<
            observation_models::ObservationModel< 3, ObservationScalarType, TimeType > >
    createObservationModel( const std::shared_ptr< ObservationModelSettings > observationSettings,
                            const simulation_setup::SystemOfBodies& bodies,
                            ObservableType topLevelObservableType = undefined_observation_model )
    {
        ...
        switch( observationSettings->observableType_ )
        {
            case position_observable: {
                ...
                if( linkEnds.size( ) != 1 )
                {
                    std::string errorMessage = "Error when making position observable model, " +
                            std::to_string( linkEnds.size( ) ) + " link ends found";
                    throw std::runtime_error( errorMessage );
                }
                ...
                {
                    throw std::runtime_error(
                            "Error when making position observable model, no observed_body found" );
                }
                ...
                {
                    throw std::runtime_error(
                            "Error, cannot yet create position function for reference point" );
                }
                ...
                // Create observation model
                observationModel = std::make_shared<
                        PositionObservationModel< ObservationScalarType, TimeType > >(
                        linkEnds,
            ...
            case relative_position_observable: {
                ...
                {
                    std::string errorMessage =
                            "Error when making relative position observable model, " +
                            std::to_string( linkEnds.size( ) ) + " link ends found";
                    throw std::runtime_error( errorMessage );
                }
                ...
                // Create observation model
                observationModel = std::make_shared<
                        RelativePositionObservationModel< ObservationScalarType, TimeType > >(
                        linkEnds,
                        std::bind( &simulation_setup::Body::getStateInBaseFrameFromEphemeris<
                                           ObservationScalarType,
                                           TimeType >,
            ...
            case euler_angle_313_observable: {
                ...
                if( linkEnds.size( ) != 1 )
                {
                    std::string errorMessage = "Error when making euler angle observable model, " +
                            std::to_string( linkEnds.size( ) ) + " link ends found";
                    throw std::runtime_error( errorMessage );
                }
                ...
                {
                    throw std::runtime_error(
                            "Error, cannot yet create euler angle function for reference point" );
                }
                ...
                if( bodies.at( linkEnds.at( observed_body ).bodyName_ )
                            ->getRotationalEphemeris( ) == nullptr )
                {
                    throw std::runtime_error(
                            "Error, cannot euler angle observable; no rotation model found" );
                }
                else
                {
                    toBodyFixedFrameFunction = std::bind(
                            &ephemerides::RotationalEphemeris::getRotationToTargetFrameTemplated<
                                    TimeType >,
                            bodies.at( linkEnds.at( observed_body ).bodyName_ )
                ...
                // Create observation model
                observationModel = std::make_shared<
                        EulerAngle313ObservationModel< ObservationScalarType, TimeType > >(
            ...
            case velocity_observable: {
                ...
                if( linkEnds.size( ) != 1 )
                {
                    std::string errorMessage = "Error when making velocity observable model, " +
                            std::to_string( linkEnds.size( ) ) + " link ends found";
                    throw std::runtime_error( errorMessage );
                }
                ...
                {
                    throw std::runtime_error(
                            "Error when making velocity observable model, no observed_body found" );
                }
                ...
                {
                    throw std::runtime_error(
                            "Error, cannot yet create velocity function for reference point" );
                }
                ...
                // Create observation model
                observationModel = std::make_shared<
                        VelocityObservationModel< ObservationScalarType, TimeType > >(
                        linkEnds,
                        std::bind( &simulation_setup::Body::getStateInBaseFrameFromEphemeris<
                                           ObservationScalarType,
                                           TimeType >,
        ...
        const simulation_setup::SystemOfBodies& bodies )
{
    ...
    for( unsigned int i = 0; i < settingsList.size( ); i++ )
    {
        observationModels[ settingsList.at( i )->linkEnds_.linkEnds_ ] =
                ObservationModelCreator< ObservationSize, ObservationScalarType, TimeType >::
                        createObservationModel( settingsList.at( i ), bodies );
    }

    return std::make_shared<
            ObservationSimulator< ObservationSize, ObservationScalarType, TimeType > >(
        ...
        switch( observableSize )
        {
            case 1: {
                observationSimulators.push_back(
                        createObservationSimulator< 1, ObservationScalarType, TimeType >(
                                observableType, it.second, bodies ) );
                break;
            }
            case 2: {
                observationSimulators.push_back(
                        createObservationSimulator< 2, ObservationScalarType, TimeType >(
                                observableType, it.second, bodies ) );
                break;
            }
            case 3: {
                observationSimulators.push_back(
                        createObservationSimulator< 3, ObservationScalarType, TimeType >(
                                observableType, it.second, bodies ) );
                break;
            }
            default:
...
std::map< ObservableType,
          std::shared_ptr< ObservationSimulatorBase< ObservationScalarType, TimeType > > >
createSortedObservationSimulators(
        const std::vector< std::shared_ptr< ObservationModelSettings > >& observationSettingsList,
        const simulation_setup::SystemOfBodies& bodies )
{
    std::map< ObservableType,
              std::shared_ptr< ObservationSimulatorBase< ObservationScalarType, TimeType > > >
            sortedObservationSimulators;

    std::vector< std::shared_ptr< ObservationSimulatorBase< ObservationScalarType, TimeType > > >
            observationSimulators = createObservationSimulators< ObservationScalarType, TimeType >(
                    observationSettingsList, bodies );
    for( unsigned int i = 0; i < observationSimulators.size( ); i++ )
    {
        sortedObservationSimulators[ observationSimulators.at( i )->getObservableType( ) ] =
...
std::vector< std::vector< std::shared_ptr< observation_models::LightTimeCorrection > > >
getLightTimeCorrections(
        const std::shared_ptr< observation_models::ObservationModel< ObservationSize,
                                                                     ObservationScalarType,
                                                                     TimeType > > observationModel )
{
    ...
    switch( observationModel->getObservableType( ) )
    {
        case observation_models::one_way_range: {
            std::shared_ptr< observation_models::OneWayRangeObservationModel< ObservationScalarType,
                                                                              TimeType > >
                    oneWayRangeModel = std::dynamic_pointer_cast<
                            observation_models::OneWayRangeObservationModel< ObservationScalarType,
                                                                             TimeType > >(
                            observationModel );
            singleObservableCorrectionList =
        ...
        case observation_models::one_way_doppler: {
            std::shared_ptr<
                    observation_models::OneWayDopplerObservationModel< ObservationScalarType,
                                                                       TimeType > >
                    oneWayRangeModel = std::dynamic_pointer_cast<
                            observation_models::OneWayDopplerObservationModel<
                                    ObservationScalarType,
                                    TimeType > >( observationModel );
            singleObservableCorrectionList =
                    ( oneWayRangeModel->getLightTimeCalculator( )->getLightTimeCorrection( ) );
        ...
        case observation_models::two_way_doppler: {
            std::shared_ptr<
                    observation_models::TwoWayDopplerObservationModel< ObservationScalarType,
                                                                       TimeType > >
                    twoWaDopplerModel = std::dynamic_pointer_cast<
                            observation_models::TwoWayDopplerObservationModel<
                                    ObservationScalarType,
                                    TimeType > >( observationModel );
            currentLightTimeCorrections.push_back( twoWaDopplerModel->getUplinkDopplerCalculator( )
                                                           ->getLightTimeCalculator( )
                                                           ->getLightTimeCorrection( ) );
            currentLightTimeCorrections.push_back(
                    twoWaDopplerModel->getDownlinkDopplerCalculator( )
                            ->getLightTimeCalculator( )
                            ->getLightTimeCorrection( ) );
            break;
        }
        case observation_models::angular_position: {
            std::shared_ptr<
                    observation_models::AngularPositionObservationModel< ObservationScalarType,
                                                                         TimeType > >
                    angularPositionModel = std::dynamic_pointer_cast<
                            observation_models::AngularPositionObservationModel<
                                    ObservationScalarType,
                                    TimeType > >( observationModel );
            singleObservableCorrectionList =
        ...
        case observation_models::one_way_differenced_range: {
            std::shared_ptr< observation_models::OneWayDifferencedRangeObservationModel<
                    ...
                    oneWayDifferencedRangeObservationModel = std::dynamic_pointer_cast<
                            observation_models::OneWayDifferencedRangeObservationModel<
                                    ObservationScalarType,
                                    TimeType > >( observationModel );
            currentLightTimeCorrections.push_back(
        ...
        case observation_models::n_way_range: {
            std::shared_ptr< observation_models::NWayRangeObservationModel< ObservationScalarType,
                                                                            TimeType > >
                    nWayRangeObservationModel = std::dynamic_pointer_cast<
                            observation_models::NWayRangeObservationModel< ObservationScalarType,
                                                                           TimeType > >(
                            observationModel );
            ...
            {
                currentLightTimeCorrections.push_back(
                        lightTimeCalculatorList.at( i )->getLightTimeCorrection( ) );
            }
            break;
        }
        case observation_models::dsn_n_way_range: {
            std::shared_ptr<
                    observation_models::DsnNWayRangeObservationModel< ObservationScalarType,
                                                                      TimeType > >
                    nWayRangeObservationModel = std::dynamic_pointer_cast<
                            observation_models::DsnNWayRangeObservationModel< ObservationScalarType,
                                                                              TimeType > >(
            ...
            std::vector< std::shared_ptr<
                    observation_models::LightTimeCalculator< ObservationScalarType, TimeType > > >
                    lightTimeCalculatorList = nWayRangeObservationModel->getLightTimeCalculator( )
        ...
        case observation_models::relative_angular_position: {
            std::shared_ptr< observation_models::RelativeAngularPositionObservationModel<
                    ...
                    relativeAngularPositionModel = std::dynamic_pointer_cast<
                            observation_models::RelativeAngularPositionObservationModel<
                                    ObservationScalarType,
                                    TimeType > >( observationModel );
            currentLightTimeCorrections.push_back(
...
PerLinkEndPerLightTimeSolutionCorrections getLightTimeCorrectionsList(
        const std::map<
                observation_models::LinkEnds,
                std::shared_ptr< observation_models::ObservationModel< ObservationSize,
                                                                       ObservationScalarType,
                                                                       TimeType > > >
                observationModels )
{
    ...
    observation_models::ObservableType observableType =
            observationModels.begin( )->second->getObservableType( );
    ...
    for( typename std::map< observation_models::LinkEnds,
                            std::shared_ptr< observation_models::ObservationModel<
                                    ObservationSize,
                                    ObservationScalarType,
                                    TimeType > > >::const_iterator observationModelIterator =
                 observationModels.begin( );
         ...
         observationModelIterator++ )
    {
        ...
        {
            lightTimeCorrectionsList[ observationModelIterator->first ] =
                    currentLightTimeCorrections;
        }
    }
...
class UndifferencedObservationModelExtractor
{
   public:
    template< typename ObservationScalarType, typename TimeType >
    static std::pair< std::shared_ptr< observation_models::ObservationModel< ObservationSize,
                                                                             ObservationScalarType,
                                                                             TimeType > >,
                      std::shared_ptr< observation_models::ObservationModel< ObservationSize,
                                                                             ObservationScalarType,
                                                                             TimeType > > >
    extract( const std::shared_ptr< observation_models::ObservationModel< ObservationSize,
                                                                          ObservationScalarType,
                                                                          TimeType > >
        ...
        switch( differencedObservationModel->getObservableType( ) )
        {
            case observation_models::one_way_differenced_range: {
                std::shared_ptr< observation_models::OneWayDifferencedRangeObservationModel<
                        ...
                        oneWayDifferencedRangeObservationModel = std::dynamic_pointer_cast<
                                observation_models::OneWayDifferencedRangeObservationModel<
                                        ObservationScalarType,
                                        TimeType > >( differencedObservationModel );
                firstObservationModel = std::make_shared<
                        observation_models::OneWayRangeObservationModel< ObservationScalarType,
                                                                         TimeType > >(
                        oneWayDifferencedRangeObservationModel->getLinkEnds( ),
                        oneWayDifferencedRangeObservationModel->getArcStartLightTimeCalculator( ) );
                secondObservationModel = std::make_shared<
                        observation_models::OneWayRangeObservationModel< ObservationScalarType,
                                                                         TimeType > >(
                        oneWayDifferencedRangeObservationModel->getLinkEnds( ),
                        oneWayDifferencedRangeObservationModel->getArcEndLightTimeCalculator( ) );
            ...
            case observation_models::n_way_differenced_range: {
                std::shared_ptr< observation_models::NWayDifferencedRangeObservationModel<
                        ...
                        nWayDifferencedRangeObservationModel = std::dynamic_pointer_cast<
                                observation_models::NWayDifferencedRangeObservationModel<
                                        ObservationScalarType,
                                        TimeType > >( differencedObservationModel );
                firstObservationModel =
                        nWayDifferencedRangeObservationModel->getArcStartObservationModel( );
                secondObservationModel =
                        nWayDifferencedRangeObservationModel->getArcEndObservationModel( );
                break;
            }
            case observation_models::dsn_n_way_averaged_doppler: {
                std::shared_ptr< observation_models::DsnNWayAveragedDopplerObservationModel<
                        ObservationScalarType,
                        TimeType > >
                        dsnNWayAveragedDopplerObservationModel = std::dynamic_pointer_cast<
                                observation_models::DsnNWayAveragedDopplerObservationModel<
                                        ObservationScalarType,
                                        TimeType > >( differencedObservationModel );
                firstObservationModel =
                        dsnNWayAveragedDopplerObservationModel->getArcStartObservationModel( );
                secondObservationModel =
                        dsnNWayAveragedDopplerObservationModel->getArcEndObservationModel( );
                break;
            }
            ...
            default:
                std::string errorMessage =
                        ...
                        "type " +
                        std::to_string( differencedObservationModel->getObservableType( ) ) +
                        " not recognized.";
                throw std::runtime_error( errorMessage );
        }
