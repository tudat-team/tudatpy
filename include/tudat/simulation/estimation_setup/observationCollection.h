...
namespace tudat
{
    ...
    namespace observation_models
    {
        ...
        public:
            ...
            ObservationCollection(const SortedObservationSets &observationSetList = SortedObservationSets()) : observationSetList_(observationSetList)
            {
            ...
            ObservationCollection(
                const std::vector<std::shared_ptr<SingleObservationSet<ObservationScalarType, TimeType>>> observationSetList) : observationSetList_(createSortedObservationSetList<ObservationScalarType, TimeType>(observationSetList))
            {
                setObservationSetIndices();
                setConcatenatedObservationsAndTimes();
            }
            ...
            std::pair<double, double> getTimeBoundsDouble()
            {
                ...
                return std::make_pair(static_cast<double>(timeBounds.first),
                ...
                std::shared_ptr<ObservationCollectionParser> observationParser = std::make_shared<ObservationCollectionParser>()) const
            {
                ...
                {
                    doubleTimeBounds.push_back(
                        std::make_pair(static_cast<double>(bounds.first), static_cast<double>(bounds.second)));
                }
            ...
            std::pair<Eigen::Matrix<ObservationScalarType, Eigen::Dynamic, 1>, std::vector<double>>
            getConcatenatedObservationsAndTimesDouble(
                std::shared_ptr<ObservationCollectionParser> observationParser = std::make_shared<ObservationCollectionParser>())
            {
                ...
                const std::shared_ptr<ObservationCollectionParser> parser = std::make_shared<ObservationCollectionParser>())
            {
                ...
                {
                    doubleHistories.push_back(
                        utilities::staticCastMapKeys<double, TimeType, Eigen::VectorXd>(history));
                }
