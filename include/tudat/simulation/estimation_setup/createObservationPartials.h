...
void splitObservationPartialsAndScalers(
        const std::map<
                ...
                observationPartialsAndScalers,
        std::map< observation_models::LinkEnds,
                  std::map< std::pair< int, int >,
                            std::shared_ptr< observation_partials::ObservationPartial<
                                    ObservationSize > > > >& observationPartials,
        std::map< observation_models::LinkEnds,
                  std::shared_ptr< observation_partials::PositionPartialScaling > >&
                observationPartialScalers )
{
    ...
    for( typename std::map<
                 ...
                 rangePartialPairIterator = observationPartialsAndScalers.begin( );
         rangePartialPairIterator != observationPartialsAndScalers.end( );
         rangePartialPairIterator++ )
    {
        observationPartials[ rangePartialPairIterator->first ] =
                rangePartialPairIterator->second.first;
        observationPartialScalers[ rangePartialPairIterator->first ] =
                rangePartialPairIterator->second.second;
    }
}
...
class ObservationPartialCreator
{
   public:
    ...
    createObservationPartials(
            ...
            const simulation_setup::SystemOfBodies& bodies,
            const std::shared_ptr<
                    estimatable_parameters::EstimatableParameterSet< ObservationScalarType > >
                    parametersToEstimate,
            const bool isPartialForDifferencedObservable = false,
            const bool isPartialForConcatenatedObservable = false,
            const std::shared_ptr< propagators::DependentVariablesInterface< TimeType > >
                    dependentVariablesInterface = std::shared_ptr<
                            propagators::DependentVariablesInterface< TimeType > >( ) );
};
                            ...
                            propagators::DependentVariablesInterface< TimeType > >( ) )
    {
        ...
        switch( observationModel->getObservableType( ) )
        {
            case observation_models::angular_position:
                observationPartials =
                        createSingleLinkObservationPartials< ObservationScalarType, 2, TimeType >(
                                observationModel,
                                bodies,
                                parametersToEstimate,
            ...
            case observation_models::relative_angular_position:
                observationPartials =
                        createDifferencedObservablePartials< ObservationScalarType, TimeType, 2 >(
                                observationModel,
                                bodies,
                                parametersToEstimate,
                                isPartialForDifferencedObservable,
                            ...
                            propagators::DependentVariablesInterface< TimeType > >( ) )
    {
        ...
        switch( observationModel->getObservableType( ) )
        {
            case observation_models::position_observable:
                observationPartials =
                        createSingleLinkObservationPartials< ObservationScalarType, 3, TimeType >(
                                observationModel,
                                bodies,
                                parametersToEstimate,
                                isPartialForDifferencedObservable,
                        ...
                        std::shared_ptr< propagators::DependentVariablesInterface< TimeType > >( ) )
{
    ...
    observation_models::ObservableType observableType =
            observation_models::undefined_observation_model;
    for( auto it: observationModelList )
    {
        ...
        partialsList[ it.first ] =
                ObservationPartialCreator< ObservationSize, ObservationScalarType, TimeType >::
                        createObservationPartials( it.second,
                                                   bodies,
                                                   parametersToEstimate,
                                                   isPartialForDifferencedObservable,
                                                   isPartialForConcatenatedObservable,
...
{
   public:
    static std::shared_ptr< ObservationPartial< ObservationSize > >
        ...
        switch( differencedObservableType )
        {
            case one_way_differenced_range: {
                if( !isParameterObservationLinkTimeProperty(
                            getDifferencedPartialParameterIdentifier( firstPartial, secondPartial )
                                    .first ) )
                {
                    if( firstPartial != nullptr )
                    {
                        if( std::dynamic_pointer_cast< DirectObservationPartial< 1 > >(
                                    firstPartial ) == nullptr )
                        {
                            throw std::runtime_error(
                                    "Error when creating one-way differenced range partial; first "
                                    "input object type is incompatible" );
                        }
                        else if( std::dynamic_pointer_cast< DirectObservationPartial< 1 > >(
                                         firstPartial )
            ...
            case n_way_differenced_range: {
                ...
                differencedPartial = std::make_shared< DifferencedObservablePartial< 1 > >(
                        ...
                        getUndifferencedTimeAndStateIndices( n_way_differenced_range,
                                                             linkEnds.size( ) ) );
                break;
            }
            case dsn_n_way_averaged_doppler: {
                ...
                const std::function< double( std::vector< FrequencyBands >, double ) >
                        receivedFrequencyFunction =
                                createLinkFrequencyFunction( bodies,
                                                             linkEnds,
                                                             observation_models::retransmitter,
                ...
                const std::function< double(
                        ...
                        const bool ) >
                        scalingFactorFunction = std::bind(
                                observation_models::getDsnNWayAveragedDopplerScalingFactor,
                                receivedFrequencyFunction,
                                std::placeholders::_1,
                                std::placeholders::_2,
                                std::placeholders::_3,
                ...
                differencedPartial = std::make_shared< DifferencedObservablePartial< 1 > >(
                        ...
                        getUndifferencedTimeAndStateIndices( dsn_n_way_averaged_doppler,
                                                             linkEnds.size( ) ) );
                break;
            }
            default:
                throw std::runtime_error(
                        "Error when creating differenced observable partial (size 1); observable " +
        ...
        switch( differencedObservableType )
        {
            case relative_angular_position: {
                                    ...
                                    .first ) )
                {
                    if( firstPartial != nullptr )
                    {
                        if( std::dynamic_pointer_cast< DirectObservationPartial< 2 > >(
                                    firstPartial ) == nullptr )
                        {
                            throw std::runtime_error(
                        ...
                        else if( std::dynamic_pointer_cast< DirectObservationPartial< 2 > >(
                                         firstPartial )
                                         ->getObservableType( ) != angular_position )
                        {
                            throw std::runtime_error(
                                    "Error when creating relative angular position partial; first "
                                    "input observable type is incompatible" );
                ...
                differencedPartial = std::make_shared< DifferencedObservablePartial< 2 > >(
                        ...
                        getUndifferencedTimeAndStateIndices( relative_angular_position,
                                                             linkEnds.size( ) ) );
                break;
            }
            default:
                throw std::runtime_error(
                        "Error when creating differenced observable partial (size 2); observable " +
                        getObservableName( differencedObservableType ) + " is not differenced. " );
        }
        return differencedPartial;
    }
        ...
        const bool isPartialForConcatenatedObservable )
{
    ...
    ObservableType undifferencedObservableType =
            getUndifferencedObservableType( differencedObservableType );

    auto undifferencedObservationModels =
            UndifferencedObservationModelExtractor< ObservationSize >::extract( observationModel );

    std::shared_ptr< ObservationModel< ObservationSize, ParameterType, TimeType > >
            undifferencedObservationModelFirst = undifferencedObservationModels.first;
    std::shared_ptr< ObservationModel< ObservationSize, ParameterType, TimeType > >
            undifferencedObservationModelSecond = undifferencedObservationModels.second;

    std::pair< std::map< std::pair< int, int >,
                         std::shared_ptr< ObservationPartial< ObservationSize > > >,
               std::shared_ptr< PositionPartialScaling > >
            firstUndifferencedObservablePartials =
                    ObservationPartialCreator< ObservationSize, ParameterType, TimeType >::
                            createObservationPartials( undifferencedObservationModelFirst,
                                                       bodies,
                                                       parametersToEstimate,
                                                       true,
                                                       isPartialForConcatenatedObservable );
    ...
    std::pair< std::map< std::pair< int, int >,
            ...
            secondUndifferencedObservablePartials =
                    ObservationPartialCreator< ObservationSize, ParameterType, TimeType >::
                            createObservationPartials( undifferencedObservationModelSecond,
                                                       bodies,
                                                       parametersToEstimate,
                                                       true,
                                                       isPartialForConcatenatedObservable );
    ...
    std::map< std::pair< int, int >,
            ...
            mergedPartials = mergeUndifferencedPartialContribution(
                    firstUndifferencedObservablePartials.first,
    ...
    for( auto it: mergedPartials )
    {
        ...
        differencedObservationPartialList[ it.first ] = DifferencedObservationPartialCreator<
                ObservationSize >::createDifferencedObservationPartial( differencedObservableType,
                                                                        it.second.first,
                                                                        it.second.second,
                                                                        linkEnds,
                                                                        bodies );
         ...
         parameterIterator++ )
    {
        ...
        if( !isParameterObservationLinkTimeProperty(
            ...
            isParameterObservationLinkProperty(
                    parameterIterator->second->getParameterName( ).first ) )
        {
            currentDifferencedObservationPartial =
                    createObservationPartialWrtLinkProperty< ObservationSize >(
                            linkEnds,
    ...
    differencedPartialsAndScaling = std::make_pair(
            differencedObservationPartialList,
            ObservationPartialScalingCreator< ObservationSize >::
                    template createDifferencedPositionPartialScalingObject< ParameterType,
                                                                            TimeType >(
                            differencedObservableType,
