...
#ifndef TUDAT_CREATE_OBSERVATION_DATASET_H
                                         ...
                                         const bool applyCorrections = false )
{
    ...
    if( applyCorrections )
    {
        ...
        {
            throw std::runtime_error( "Error when adding tracking data to an observation dataset, the size of the corrections (" +
        ...
        for( unsigned int i = 0; i < observations.size( ); i++ )
        {
            ...
            {
                throw std::runtime_error(
                        "Error when adding tracking data to an observation dataset, size of single observation "
                        "correction (" +
...
#endif  // TUDAT_CREATE_OBSERVATION_DATASET_H
