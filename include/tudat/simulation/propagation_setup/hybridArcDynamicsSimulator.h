...
public:
    ...
    //! Construct a hybrid-arc simulator from fully configured propagator settings.
    /*!
     * \param bodies Bodies used by the propagation.
     * \param hybridPropagatorSettings Hybrid-arc settings containing the epochs, integrators, and output settings.
     * \param areEquationsOfMotionToBeIntegrated Whether to integrate immediately after construction.
     * \param addSingleArcBodiesToMultiArcDynamics Whether single-arc bodies are also added to the multi-arc dynamics.
     */
