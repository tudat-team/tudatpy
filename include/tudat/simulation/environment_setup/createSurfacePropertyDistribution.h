 ...
 */
enum class SurfacePropertyDistributionType { constant, spherical_harmonics, second_degree_zonal_periodic, custom_surface_distribution };
...
enum class SphericalHarmonicsSurfacePropertyDistributionModel {
    custom,
    albedo_dlam1 /**< DLAM-1 lunar albedo model: Floberghagen, R. et al. "Lunar Albedo Force Modeling and its Effect on Low Lunar Orbit and
                    Gravity Field Determination". ASR 23. 4(1999): 733-738. */
};
...
public:
     ...
     */
    explicit SphericalHarmonicsSurfacePropertyDistributionSettings( const Eigen::MatrixXd& cosineCoefficients,
     ...
     */
    explicit SphericalHarmonicsSurfacePropertyDistributionSettings( SphericalHarmonicsSurfacePropertyDistributionModel model );
...
enum class KnockeTypeSurfacePropertyDistributionModel {
    custom,
    albedo_knocke,    /**< Knocke Earth albedo model: Knocke, Philip et al. "Earth radiation pressure effects on satellites." Astrodynamics
                         Conference. American Institute of Aeronautics and Astronautics, 1988. */
    emissivity_knocke /**< Knocke Earth emissivity model: Knocke, Philip et al. "Earth radiation pressure effects on satellites."
...
public:
     ...
     */
    explicit SecondDegreeZonalPeriodicSurfacePropertyDistributionSettings( const double a0,
                                                                           const double c0,
                                                                           const double c1,
                                                                           const double c2,
                                                                           const double a2,
     ...
     */
    explicit SecondDegreeZonalPeriodicSurfacePropertyDistributionSettings( KnockeTypeSurfacePropertyDistributionModel model );
 ...
 */
inline std::shared_ptr< SurfacePropertyDistributionSettings > constantSurfacePropertyDistributionSettings( double constantValue )
{
 ...
 */
inline std::shared_ptr< SurfacePropertyDistributionSettings > sphericalHarmonicsSurfacePropertyDistributionSettings(
        const Eigen::MatrixXd& cosineCoefficients,
        const Eigen::MatrixXd& sineCoefficients )
{
    return std::make_shared< SphericalHarmonicsSurfacePropertyDistributionSettings >( cosineCoefficients, sineCoefficients );
}
 ...
 */
inline std::shared_ptr< SurfacePropertyDistributionSettings > secondDegreeZonalPeriodicSurfacePropertyDistributionSettings(
...
manualSecondDegreeZonalPeriodicSurfacePropertyDistributionSettings( const double a0,
                                                                    const double c0,
                                                                    const double c1,
                                                                    const double c2,
                                                                    const double a2,
                                                                    ...
                                                                    const double period )
{
    return std::make_shared< SecondDegreeZonalPeriodicSurfacePropertyDistributionSettings >( a0, c0, c1, c2, a2, referenceEpoch, period );
}

inline std::shared_ptr< SurfacePropertyDistributionSettings > customSurfacePropertyDistributionSettings(
        const std::function< double( const double, const double, const double ) > customFunction )
{
