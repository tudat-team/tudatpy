...
#ifndef TUDAT_PROPAGATION_SETUP_H
#define TUDAT_PROPAGATION_SETUP_H

#include "propagation_setup/accelerationSettings.h"
#include "propagation_setup/createAccelerationModels.h"
