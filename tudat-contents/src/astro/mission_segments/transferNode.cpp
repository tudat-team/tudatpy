...
void DepartureWithFixedOutgoingVelocityNode::computeNode( )
{
    ...
    totalNodeDeltaV_ = mission_segments::computeEscapeOrCaptureDeltaV( centralBodyGravitationalParameter_,
                                                                       departureSemiMajorAxis_,
                                                                       departureEccentricity_,
                                                                       ( outgoingVelocity_ - nodeState_.segment< 3 >( 3 ) ).norm( ) );
}

DepartureWithFreeOutgoingVelocityNode::DepartureWithFreeOutgoingVelocityNode( const std::shared_ptr< ephemerides::Ephemeris > nodeEphemeris,
                                                                              const double centralBodyGravitationalParameter,
                                                                              const double departureSemiMajorAxis,
                                                                              const double departureEccentricity ):
    TransferNode( nodeEphemeris, escape_and_departure ), centralBodyGravitationalParameter_( centralBodyGravitationalParameter ),
...
void CaptureWithFixedIncomingVelocityNode::computeNode( )
{
    ...
    totalNodeDeltaV_ = mission_segments::computeEscapeOrCaptureDeltaV( centralBodyGravitationalParameter_,
                                                                       captureSemiMajorAxis_,
                                                                       captureEccentricity_,
                                                                       ( incomingVelocity_ - nodeState_.segment< 3 >( 3 ) ).norm( ) );
}

CaptureWithFreeIncomingVelocityNode::CaptureWithFreeIncomingVelocityNode( const std::shared_ptr< ephemerides::Ephemeris > nodeEphemeris,
                                                                          const double centralBodyGravitationalParameter,
                                                                          const double captureSemiMajorAxis,
                                                                          const double captureEccentricity ):
    TransferNode( nodeEphemeris, capture_and_insertion ), centralBodyGravitationalParameter_( centralBodyGravitationalParameter ),
...
void SwingbyWithFixedIncomingFixedOutgoingVelocity::computeNode( )
{
    ...
    totalNodeDeltaV_ = calculateGravityAssistDeltaV( centralBodyGravitationalParameter_,
                                                     nodeState_.segment< 3 >( 3 ),
                                                     incomingVelocity_,
                                                     outgoingVelocity_,
...
void SwingbyWithFixedIncomingFreeOutgoingVelocity::computeNode( )
{
    ...
    outgoingVelocity_ = mission_segments::calculatePoweredGravityAssistOutgoingVelocity( centralBodyGravitationalParameter_,
                                                                                         nodeState_.segment< 3 >( 3 ),
                                                                                         incomingVelocity_,
                                                                                         outgoingRotationAngle_,
                                                                                         periapsisRadius_,
                                                                                         swingbyDeltaV_ );
...
void SwingbyWithFreeIncomingFixedOutgoingVelocity::computeNode( )
{
    ...
    incomingVelocity_ = mission_segments::calculatePoweredGravityAssistIncomingVelocity( centralBodyGravitationalParameter_,
                                                                                         nodeState_.segment< 3 >( 3 ),
                                                                                         outgoingVelocity_,
                                                                                         incomingRotationAngle_,
                                                                                         periapsisRadius_,
                                                                                         swingbyDeltaV_ );
